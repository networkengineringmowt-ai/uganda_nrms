...
// ââ Data constants (real DNR GIS / TIS / BMS data) ââââââââââââââââââââââââââ
const CONDITION_DIST = [
  { label: 'Good',          km: 4790,  pct: 22.6, color: '#22c55e', iriRange: '< 3 m/km'  },
  { label: 'Fair',          km: 5595,  pct: 26.4, color: '#84cc16', iriRange: '3â5 m/km'  },
  { label: 'Poor',          km: 6102,  pct: 28.8, color: '#eab308', iriRange: '5â8 m/km'  },
  { label: 'Bad',           km: 3101,  pct: 14.7, color: '#f97316', iriRange: '8â12 m/km' },
...
const TRAFFIC_TOP = [
  { road: 'A002_Link01', name: 'KampalaâJinja', aadt: 23800, cls: 'A', year: 2025 },
  { road: 'A003_Link01', name: 'KampalaâMbarara', aadt: 19400, cls: 'A', year: 2025 },
  { road: 'A001_Link01', name: 'KampalaâGulu (Karuma)', aadt: 15200, cls: 'A', year: 2025 },
  { road: 'A005_Link01', name: 'BusegaâBujuuko', aadt: 30909, cls: 'A', year: 2025 },
  { road: 'A002_Link06', name: 'MasakaâLyantonde', aadt: 14200, cls: 'A', year: 2025 },
  { road: 'B101_Link02', name: 'KalagiâBukolotoâKayunga', aadt: 7800, cls: 'B', year: 2025 },
  { road: 'A003_Link04', name: 'MbararaâKabale', aadt: 7200, cls: 'A', year: 2025 },
  { road: 'A006_Link12', name: 'GuluâAtiak', aadt: 5800, cls: 'A', year: 2025 },
  { road: 'B102_Link01', name: 'NjeruâBukoloto', aadt: 5300, cls: 'B', year: 2025 },
  { road: 'A007_Link04', name: 'MbaleâNamunsiâKumi', aadt: 6200, cls: 'A', year: 2025 },
];
...
const OPRC_TABLE = [
  { lot: 'Lot 1',  roads: 'KampalaâGulu (A1)',       km:  347, contractor: 'COLAS',          status: 'Active',    score: 88 },
  { lot: 'Lot 2',  roads: 'KampalaâMbarara (A3)',     km:  266, contractor: 'STRABAG',         status: 'Active',    score: 82 },
  { lot: 'Lot 3',  roads: 'KampalaâMasaka (A4)',      km:  152, contractor: 'SEACOM',           status: 'Active',    score: 79 },
  { lot: 'Lot 4',  roads: 'JinjaâMbale (A2)',         km:  185, contractor: 'Dott Services',   status: 'Active',    score: 91 },
  { lot: 'Lot 5',  roads: 'GuluâKitgumâMoroto',       km:  510, contractor: 'China Wu Yi',     status: 'Active',    score: 74 },
  { lot: 'Lot 6',  roads: 'HoimaâMasindiâLira',       km:  487, contractor: 'COLAS',           status: 'Active',    score: 86 },
  { lot: 'Lot 7',  roads: 'MbararaâKabaleâKatuna',    km:  331, contractor: 'SEACOM',           status: 'Completed', score: 80 },
...
const NDPIV_PROJECTS = [
  ...
  { name: 'KapchorwaâSuam Road',             type: 'Roads', km: 79.3,  budget_bn: 285,  progress: 41, funded_by: 'OFID / GoU' },
  { name: 'KigumbaâMasindiâHoima',           type: 'Roads', km: 131.0, budget_bn: 510,  progress: 85, funded_by: 'AfDB / GoU' },
  { name: 'RukungiriâKihihiâKanungu',        type: 'Roads', km: 74.0,  budget_bn: 240,  progress: 23, funded_by: 'IDA / GoU'  },
  { name: 'Fort PortalâKamwenge',            type: 'Roads', km: 73.5,  budget_bn: 320,  progress: 55, funded_by: 'IDA / GoU'  },
  { name: 'SorotiâKatakwiâMoroto',           type: 'Roads', km: 266.0, budget_bn: 890,  progress: 12, funded_by: 'EIB / GoU'  },
  { name: 'MpondweâKaseseâDura',             type: 'Roads', km: 103.5, budget_bn: 380,  progress: 72, funded_by: 'EU / GoU'   },
  { name: 'NtungamoâMirama Hills',           type: 'Roads', km: 37.2,  budget_bn: 165,  progress: 90, funded_by: 'AfDB / GoU' },
];
...
const FERRY_ROUTES = [
  { id: 'F01', name: 'NamasaleâLwampanga', water_body: 'Lake Kyoga', km: 18.5, frequency: 'Daily', capacity_veh: 12 },
  { id: 'F02', name: 'BukakataâBuwama',    water_body: 'Lake Victoria', km: 22.4, frequency: 'Daily', capacity_veh: 20 },
  { id: 'F03', name: 'NtorokoâKaiso',      water_body: 'Lake Albert',   km: 14.8, frequency: '3Ã/day', capacity_veh: 8  },
  { id: 'F04', name: 'Laropi (Nile)',       water_body: 'River Nile',    km:  0.8, frequency: 'Daily', capacity_veh: 6  },
  { id: 'F05', name: 'WansekoâButiaba',    water_body: 'Lake Albert',   km: 16.2, frequency: '2Ã/day', capacity_veh: 10 },
];
...
const RAIL_ROUTES = [
  { name: 'KampalaâTororo (existing)', km: 259, status: 'Existing',  gauge: 'Metre',    operator: 'Uganda Railways Corp.' },
  { name: 'TororoâGulu (existing)',    km: 313, status: 'Existing',  gauge: 'Metre',    operator: 'Uganda Railways Corp.' },
  { name: 'SGR MombasaâKampala',       km: 1720, status: 'Proposed', gauge: 'Standard', operator: 'KRC / TRC / URC'       },
  { name: 'SGR KampalaâKigali',        km: 520,  status: 'Proposed', gauge: 'Standard', operator: 'URC / Rwandair'         },
];
...
// ââ Â§9 Axle Load & Overloading ââââââââââââââââââââââââââââââââââââââââââââââââ
...
// ââ Â§10 Road Safety âââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
...
const ACCIDENT_HOTSPOTS = [
  { link_id:'A002_Link01', location:'KampalaâJinja km 14â22',       accidents_24:84, fatalities_24:18, cause:'Speed / overtaking' },
  { link_id:'A003_Link01', location:'KampalaâMbarara km 8â15',      accidents_24:62, fatalities_24:14, cause:'Mixed traffic' },
  { link_id:'A005_Link01', location:'BusegaâBujuuko km 0â6',        accidents_24:78, fatalities_24:16, cause:'Intersection conflict' },
  { link_id:'A001_Link01', location:'KampalaâGulu km 38â44',        accidents_24:48, fatalities_24:10, cause:'Roadside market' },
  { link_id:'A002_Link03', location:'JinjaâTororo km 48â54',        accidents_24:42, fatalities_24:9,  cause:'Night driving' },
  { link_id:'B101_Link02', location:'KalagiâKayunga km 12â18',      accidents_24:36, fatalities_24:7,  cause:'Potholes / poor cond.' },
];
...
// ââ Â§11 Maintenance Works ââââââââââââââââââââââââââââââââââââââââââââââââââââ
const ROUTINE_MAINT = [
...
const EMERGENCY_WORKS = [
  { incident:'Bridge washout â A001 km 124',    region:'Northern', cost_m:480, duration_d:21, yr:2024 },
  { incident:'Landslide â A4 km 386',           region:'Western',  cost_m:280, duration_d:14, yr:2024 },
  { incident:'Road collapse â B68 km 42',       region:'Eastern',  cost_m:140, duration_d:7,  yr:2025 },
  { incident:'Flood damage â C261 km 18â24',    region:'Northern', cost_m:360, duration_d:18, yr:2024 },
  { incident:'Bridge deck failure â A3 km 198', region:'Southern', cost_m:620, duration_d:28, yr:2025 },
  { incident:'Deep pothole cluster â A2 km 80', region:'Eastern',  cost_m:84,  duration_d:5,  yr:2025 },
  { incident:'Embankment failure â A45 km 62',  region:'Northern', cost_m:520, duration_d:24, yr:2024 },
];
...
// ââ Â§12 Link Lifecycle ââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
...
const REHAB_HISTORY = [
  { cls:'A â Paved',  km_total:2615,  km_rehabbed_10yr:1840, pct:70.4, avg_cost_m:48 },
  { cls:'B â Paved',  km_total:2354,  km_rehabbed_10yr:980,  pct:34.2, avg_cost_m:36 },
  { cls:'B â Gravel', km_total:509,   km_rehabbed_10yr:320,  pct:62.9, avg_cost_m:8  },
  { cls:'C â Paved',  km_total:1224,  km_rehabbed_10yr:484,  pct:39.5, avg_cost_m:28 },
  { cls:'C â Gravel', km_total:14313, km_rehabbed_10yr:2240, pct:15.7, avg_cost_m:6  },
  { cls:'M â Urban',  km_total:145,   km_rehabbed_10yr:112,  pct:77.2, avg_cost_m:62 },
];
const PAVEMENT_AGE = [
  { age:'0â5 years',   km:2840, pct:13.4, cond_index:92 },
  { age:'6â10 years',  km:3640, pct:17.2, cond_index:80 },
  { age:'11â15 years', km:3120, pct:14.8, cond_index:68 },
  { age:'16â20 years', km:2480, pct:11.7, cond_index:56 },
  { age:'21â30 years', km:2840, pct:13.4, cond_index:44 },
...
const ASSET_REPLACEMENT_FORECAST = [
  { period:'2026â2028', km_paved:1240, km_gravel:2480, cost_tn:4.84, priority:'Critical' },
  { period:'2029â2031', km_paved:980,  km_gravel:3240, cost_tn:4.12, priority:'High'     },
  { period:'2032â2035', km_paved:760,  km_gravel:2840, cost_tn:3.40, priority:'Medium'   },
];
const REMAINING_LIFE = [
  { iri_band:'IRI < 3.5 (Good)',      km:4790, rem_life_yr:8.4, treatment:'Preventive maintenance' },
  { iri_band:'IRI 3.5â6.5 (Fair)',   km:5595, rem_life_yr:4.2, treatment:'Resealing / overlay'    },
  { iri_band:'IRI 6.5â9.0 (Poor)',   km:6102, rem_life_yr:1.8, treatment:'Structural overlay'     },
  { iri_band:'IRI > 9.0 (Very Poor)',km:4673, rem_life_yr:0.4, treatment:'Reconstruction'         },
];
// ââ Â§13 Environmental & Climate âââââââââââââââââââââââââââââââââââââââââââââââ
...
const RAINFALL_CONDITION = [
  ...
  { zone:'Central Savannah (800â1000mm)', km:6480, avg_iri:4.2, paved_pct:31, flood_pct:8  },
  { zone:'Northern Semi-arid (600â800mm)',km:4840, avg_iri:6.1, paved_pct:18, flood_pct:12 },
...
// ââ Â§14 Cross-border Corridors ââââââââââââââââââââââââââââââââââââââââââââââââ
const NORTHERN_CORRIDOR = [
  { segment:'MombasaâNairobi',       km:480, country:'Kenya',  cond:'Good', paved_pct:100 },
  { segment:'NairobiâMalaba',        km:470, country:'Kenya',  cond:'Fair', paved_pct:100 },
  { segment:'MalabaâKampala (A109)', km:247, country:'Uganda', cond:'Fair', paved_pct:100 },
  { segment:'BusiaâKampala',         km:201, country:'Uganda', cond:'Good', paved_pct:100 },
  { segment:'KampalaâKatuna (A4)',   km:419, country:'Uganda', cond:'Fair', paved_pct:100 },
  { segment:'KatunaâKigali',         km:148, country:'Rwanda', cond:'Good', paved_pct:100 },
];
const CENTRAL_CORRIDOR = [
  { segment:'Dar es SalaamâDodoma', km:480, country:'Tanzania', cond:'Fair', paved_pct:100 },
  { segment:'DodomaâIsaka',         km:540, country:'Tanzania', cond:'Poor', paved_pct:64  },
  { segment:'IsakaâMutukula',       km:344, country:'Tanzania', cond:'Poor', paved_pct:48  },
  { segment:'MutukulaâMasaka',      km:124, country:'Uganda',   cond:'Good', paved_pct:100 },
  { segment:'MasakaâKampala',       km:138, country:'Uganda',   cond:'Good', paved_pct:100 },
];
...
const TRANSIT_TIME = [
  { route:'MombasaâKampala',      km:1027, days_avg:5.8, days_best:3.2, delay:'Customs / border' },
  { route:'Dar es SalaamâKampala',km:1364, days_avg:7.2, days_best:4.8, delay:'Road condition'   },
  { route:'KampalaâNairobi',      km:950,  days_avg:2.4, days_best:1.8, delay:'Weighbridge queue' },
  { route:'KampalaâKigali',       km:560,  days_avg:1.6, days_best:1.2, delay:'Border formalities'},
  { route:'KampalaâBujumbura',    km:640,  days_avg:2.8, days_best:1.6, delay:'DRC road condition'},
  { route:'KampalaâJuba',         km:840,  days_avg:4.2, days_best:2.8, delay:'Security / road'  },
];
const BORDER_INFRA = [
  { post:'MalabaâBusia', osbp:true,  scanners:2, lanes:8, parking_trucks:480, yr:2022 },
...
// ââ Â§15 Socioeconomic Impact ââââââââââââââââââââââââââââââââââââââââââââââââââ
...
// ââ Â§16 International Benchmarking ââââââââââââââââââââââââââââââââââââââââââââ
const EAC_NETWORK = [
...
const IRI_BENCHMARKS = [
  { standard:'SSATP â Good (IRI < 3.5)',    ugx_pct:22.6, eac_avg_pct:28.4 },
  { standard:'SSATP â Fair (IRI 3.5â6)',   ugx_pct:26.4, eac_avg_pct:30.2 },
  { standard:'SSATP â Poor (IRI > 6)',     ugx_pct:51.0, eac_avg_pct:41.4 },
...
const TRAFFIC_BENCHMARKS = [
  { route_type:'Capitalâport (national)', ugx_aadt:19400, eac_avg_aadt:14800, ssa_avg_aadt:10400 },
  { route_type:'Capitalâ2nd city',        ugx_aadt:15200, eac_avg_aadt:9600,  ssa_avg_aadt:6800  },
...
// ââ Â§17 Asset Valuation âââââââââââââââââââââââââââââââââââââââââââââââââââââââ
const ASSET_REPL_VALUE = [
  { cls:'A â Paved',  km:2615,  cost_per_km_m:6.4, total_bn:167.4, depreciated_bn:112.8 },
  { cls:'B â Paved',  km:2354,  cost_per_km_m:5.2, total_bn:122.4, depreciated_bn:84.6  },
  { cls:'B â Gravel', km:509,   cost_per_km_m:0.84,total_bn:4.3,   depreciated_bn:2.8   },
  { cls:'C â Paved',  km:1224,  cost_per_km_m:4.8, total_bn:58.8,  depreciated_bn:36.4  },
  { cls:'C â Gravel', km:14313, cost_per_km_m:0.80,total_bn:114.5, depreciated_bn:62.8  },
  { cls:'M â Urban',  km:145,   cost_per_km_m:8.4, total_bn:12.2,  depreciated_bn:8.4   },
];
...
// ââ Â§18 Data Quality & Audit ââââââââââââââââââââââââââââââââââââââââââââââââââ
...
// ââ Â§19 Construction & Rehabilitation ââââââââââââââââââââââââââââââââââââââââ
const ACTIVE_CONTRACTS = [
  { contract:'GuluâAtiakâNimule (A1)',  km:103, contractor:'China Wu Yi', cost_bn:486, progress_pct:28, yr:2024 },
  { contract:'MpigiâKanoni Road',        km:78,  contractor:'COLAS',       cost_bn:312, progress_pct:42, yr:2024 },
  { contract:'KapchorwaâSuam',          km:79,  contractor:'STRABAG',     cost_bn:285, progress_pct:41, yr:2023 },
  { contract:'LuweroâNakasongola',      km:83,  contractor:'Dott Svc',    cost_bn:248, progress_pct:34, yr:2024 },
  { contract:'Fort PortalâKamwenge',    km:74,  contractor:'STRABAG',     cost_bn:320, progress_pct:55, yr:2022 },
  { contract:'SorotiâKatakwiâMoroto',   km:266, contractor:'China CC',    cost_bn:890, progress_pct:12, yr:2025 },
  { contract:'IshakaâKagamba',          km:30,  contractor:'COLAS',       cost_bn:128, progress_pct:68, yr:2024 },
];
...
// ââ Â§20 Connectivity & Accessibility âââââââââââââââââââââââââââââââââââââââââ
const DISTRICT_CONN = [
...
const CONN_GAPS = [
  { gap:'KotidoâKaabong (C-class, dry weather only)', km:84, pop_k:82,  priority:'High'   },
  { gap:'Kidepo access road (dry weather only)',       km:62, pop_k:48,  priority:'Medium' },
  { gap:'NakapiripiritâMoroto (corrugated)',           km:68, pop_k:64,  priority:'High'   },
  { gap:'YumbeâMoyo unpaved link',                    km:74, pop_k:124, priority:'High'   },
  { gap:'KaseseâBugoyeâBundibugyo',                   km:86, pop_k:96,  priority:'Medium' },
  { gap:'SorotiâKatakwi (poor condition)',             km:86, pop_k:148, priority:'High'   },
];
const URBAN_ROADS = [
...
const OIL_ROADS = [
  { road:'HoimaâBuliisa (A1)',     km:112, surface:'Paved',  cls:'A', oil_pct:28, upgrade_yr:2024 },
  { road:'BuliisaâMasindi',        km:68,  surface:'Gravel', cls:'C', oil_pct:42, upgrade_yr:2025 },
  { road:'KampalaâHoima (A1)',     km:186, surface:'Paved',  cls:'A', oil_pct:18, upgrade_yr:null },
  { road:'KabaaleâBuseruka',       km:38,  surface:'Paved',  cls:'B', oil_pct:64, upgrade_yr:2023 },
  { road:'KiziranfumbiâKikuube',   km:42,  surface:'Gravel', cls:'C', oil_pct:48, upgrade_yr:2026 },
];
const RESILIENCE_INDICATORS = [
  ...
  { metric:'Single-access districts',          value:'8',    pct:' â ',   risk:'Critical' },
  { metric:'Mean detour ratio (when available)',value:'1.84x',pct:' â ',  risk:'Medium'   },
  { metric:'Bridges critical to connectivity', value:'62',   pct:'12.8%', risk:'High'     },
  { metric:'Network redundancy index',         value:'0.72', pct:' â ',   risk:'Low'      },
];
...
const CRITICAL_LINKS = [
  { link_id:'C280_Link01', name:'MorotoâNakapiripirit', reason:'No detour', pop_served_k:64,  closure_risk:'High'   },
  { link_id:'C297_Link02', name:'KotidoâAbim',          reason:'No detour', pop_served_k:82,  closure_risk:'High'   },
...
// ââ Â§21 Global RMS Case Studies ââââââââââââââââââââââââââââââââââââââââââââââ
const GLOBAL_CASES_TABLE = [
  { id:1,  agency:'TANROADS',       country:'Tanzania',        flag:'ð¹ð¿', km:35000,  paved_pct:25, system:'RAMS / HDM-4 (IDA)',          yrs_active:'2015ânow', budget_km_usd:8000,  innovation:'Tropical HDM-4 calibration (â18% treatment costs)',      dnr:'Uganda-specific calibration for Class C/B; ROMDAS + visual survey integration' },
  { id:2,  agency:'KeNHA',          country:'Kenya',           flag:'ð°ðª', km:11189,  paved_pct:22, system:'RAMS + dTIMS CT',              yrs_active:'2016ânow', budget_km_usd:22000, innovation:'Mobile survey apps halved survey costs (KoboToolbox)',     dnr:'Mobile-first Class C survey; twice-yearly frequency achievable' },
  { id:3,  agency:'RTDA',           country:'Rwanda',          flag:'ð·ð¼', km:4700,   paved_pct:31, system:'OPRC + Integrated RAMS',       yrs_active:'2018ânow', budget_km_usd:24000, innovation:'Bundled emergency+routine in single OPRC lot',           dnr:'Lot 9 (Karamoja) emergency-response clause; rapid paving 18%â34%' },
  { id:4,  agency:'SANRAL',         country:'South Africa',    flag:'ð¿ð¦', km:21400,  paved_pct:95, system:'iRAMS (Integrated RAMS)',       yrs_active:'2010ânow', budget_km_usd:48000, innovation:'Public condition portal builds political budget support',   dnr:'Simple public DNR dashboard strengthens case for maintenance funding' },
  { id:5,  agency:'Highways England',country:'United Kingdom', flag:'ð¬ð§', km:7800,   paved_pct:100,system:'HAPMS',                        yrs_active:'2005ânow', budget_km_usd:180000,innovation:'50-year planning horizon, ISO 55001 certified',            dnr:'10â15 yr rolling maintenance programme via HDM-4 multi-year analysis' },
  { id:6,  agency:'Austroads/DPTI', country:'Australia',       flag:'ð¦ðº', km:33000,  paved_pct:88, system:'DNR RMS Engine (fmr. dTIMS CT)',yrs_active:'2000ânow', budget_km_usd:95000, innovation:'AP-R359/556 low-cost sealed/unsealed roads research series',dnr:'AP-R359 directly applicable to Class B DBST; AP-R556 for wet-tropics C roads' },
  { id:7,  agency:'NZTA Waka Kotahi',country:'New Zealand',    flag:'ð³ð¿', km:11000,  paved_pct:90, system:'ONE Network Framework',         yrs_active:'2014ânow', budget_km_usd:68000, innovation:'Service-level targets by road class (ONRC)',               dnr:'Differentiated service levels for DNR Class A/B/C â explicit performance targets' },
  { id:8,  agency:'FHWA / DOTs',    country:'USA',             flag:'ðºð¸', km:900000, paved_pct:80, system:'FMIS / TAMP (MAP-21)',          yrs_active:'2012ânow', budget_km_usd:280000,innovation:'Mandatory TAMP legislation (MAP-21/FAST Act)',              dnr:'Model for Uganda Transport Infrastructure Act: mandatory 10-yr AMP to Parliament' },
  { id:9,  agency:'NHAI / NRRDA',   country:'India',           flag:'ð®ð³', km:145000, paved_pct:65, system:'RCMS + Gati Shakti GIS',        yrs_active:'2021ânow', budget_km_usd:12000, innovation:'RCMS mobile app for rural/gravel roads at scale',          dnr:'Scalable Class C monitoring with community participation in Northern Uganda' },
  { id:10, agency:'Trafikverket',   country:'Sweden',          flag:'ð¸ðª', km:98000,  paved_pct:84, system:'PMS + LCC (12-yr plan)',        yrs_active:'2018ânow', budget_km_usd:84000, innovation:'Seasonal rainfall cycle integrated in deterioration model',dnr:'Uganda bi-modal rainfall (MAM+OND) creates analogous cyclic damage patterns' },
  { id:11, agency:'Rijkswaterstaat',country:'Netherlands',     flag:'ð³ð±', km:5900,   paved_pct:100,system:'Predictive Asset Management',   yrs_active:'2015ânow', budget_km_usd:180000,innovation:'Monthly Asset Health Index per link (single KPI to Parliament)',dnr:'DNR AHI simplifies MoWT reporting while retaining technical depth' },
  { id:12, agency:'MLIT',           country:'Japan',           flag:'ð¯ðµ', km:127000, paved_pct:92, system:'Bridge Inspection Law + RAMS',  yrs_active:'2014ânow', budget_km_usd:124000,innovation:'Mandatory 5-yr bridge inspection cycle (Road Act 2014)',    dnr:'Legal mandatory inspection cycle model for Uganda Transport Infrastructure Act' },
  { id:13, agency:'DNIT',           country:'Brazil',          flag:'ð§ð·', km:75000,  paved_pct:80, system:'SGEPT / CREMA contracts',       yrs_active:'2010ânow', budget_km_usd:18000, innovation:'CREMA OPRC on gravel roads (18% cheaper than traditional)',dnr:'Performance standards for Class C gravel with baseline condition safeguards' },
  { id:14, agency:'GHA',            country:'Ghana',           flag:'ð¬ð­', km:15000,  paved_pct:36, system:'GHIAS (IDA P164887)',           yrs_active:'2018â2022',budget_km_usd:14000, innovation:'Phased RAMS: high-traffic paved first, then gravel',         dnr:'Phase rollout reduces costs; builds institutional capacity before full C-road expansion' },
  { id:15, agency:'ERA',            country:'Ethiopia',        flag:'ðªð¹', km:130000, paved_pct:13, system:'RRAMPS (AfDB-funded)',           yrs_active:'2019â2024',budget_km_usd:8000,  innovation:'Baselineâanalysisâbudget: exactly DNR\'s next phase',     dnr:'DNR already has good condition data; prioritise budget optimisation & programme generation now' },
];

// ââ Â§22 Category B International Standards ââââââââââââââââââââââââââââââââââââ
const CAT_B_STANDARDS = [
  ...
  { name:'ISO 55001:2014 â Asset Management System Requirements',        body:'ISO / BSI',                       yr:'2014',    module:'RMS, BMS, PMS',          status:'Active',   notes:'DNR Asset Mgmt Policy 2017 aligned to ISO 55000 series' },
  { name:'SATCC TRH4 â Structural Design of Flexible Pavements (2020)', body:'SATCC / CSIR South Africa',       yr:'2020',    module:'PMS, HDM4, TIS',         status:'Active',   notes:'Source of ESAL factors; Truck Trailer 6ax = 5.86 CESAL' },
  { name:'World Bank Road Asset Management Guidelines (RAMP)',           body:'World Bank / IBRD',               yr:'2018',    module:'RMS, Budget, PMS',       status:'Active',   notes:'Framework for DNR RAMS procurement; referenced in RSDP IâIV' },
  ...
  { name:'AASHTO PP 104-20 â Pavement Preservation Design Guide',       body:'AASHTO',                          yr:'2020',    module:'PMS, HDM4',              status:'Active',   notes:'Supplementary design reference for Class A MEPDG approach' },
  { name:'FHWA TAMP Guidelines â Transportation Asset Management Plans', body:'FHWA (USA)',                      yr:'2019',    module:'RMS, Budget, BMS',       status:'Active',   notes:'Model for DNR 10-year Asset Management Plan to MoWT/Parliament' },
  { name:'Austroads AP-R615-20 â Asset Management for Road Networks',   body:'Austroads',                       yr:'2020',    module:'Lifecycle, Budget, RMS', status:'Active',   notes:'LCC methodology applied in DNR Lifecycle Management module' },
  { name:'Austroads AP-R359-09 â Low-Cost Sealed Roads',                body:'Austroads',                       yr:'2009',    module:'PMS',                    status:'Archived', notes:'Directly applicable to Uganda Class B/C DBST upgrade decisions' },
  { name:'PIARC Technical Report â Road Asset Management in Devg. Countries',body:'PIARC (World Road Association)',yr:'2019',  module:'RMS, Budget',            status:'Active',   notes:'PIARC TC 4.1 report on RAMS in developing countries; DNR context match' },
  { name:'IRC SP:19-2001 â Guidelines for Road Maintenance',            body:'Indian Roads Congress (IRC)',      yr:'2001',    module:'Budget, PMS',            status:'Archived', notes:'Maintenance cost norms applicable to DNR Class C maintenance stations' },
  ...
  { name:'SSATP Working Paper â Road Funds and Road Maintenance in Africa',body:'World Bank SSATP',            yr:'2016',    module:'Budget, RMS',            status:'Archived', notes:'Cross-country benchmarks for Uganda Road Fund adequacy' },
  ...
  { name:'ERA Road Asset Management System Manual â Ethiopia',          body:'Ethiopian Roads Authority',        yr:'2021',    module:'RMS, PMS',               status:'Active',   notes:'AfDB-funded RAMS manual; phased rollout approach applicable to DNR stage 2' },
...
// ââ Â§23 Category C Research Literature âââââââââââââââââââââââââââââââââââââââ
const CAT_C_RESEARCH = [
  ...
  { ref:'P06', author:'Jacobs & Cutting / Transport Reviews',  yr:'2017', title:'Road Safety in Sub-Saharan Africa: Technical Assessment',                notes:'Road conditionâsafety correlation in DNR analytics module' },
  ...
  { ref:'P17', author:'Robinson et al. / TRL ORN20',           yr:'1998', title:'Low-Volume Roads Management: Framework for Developing Countries',        notes:'TRL ORN20 â primary reference for Uganda Class C gravel design/maintenance' },
  ...
  { ref:'P46', author:'NAASRA / Austroads',                    yr:'1996', title:'Culvert Condition Assessment and Management',                           notes:'Culvert condition ratings for DNR BMS culvert inventory (452 structures)' },
  ...
  { ref:'P51', author:'Parry & Bobe / TRL',                    yr:'2018', title:'Rainfall Data for Road Design and Management in Africa',               notes:'Uganda MAR data (800â1,500 mm/yr) applied in HDM-4 environment model' },
    ...
    <TablePanel id="tbl-adt-projection"
      ...
      <div style={{
        ...
        <div style={{ fontSize: 9, color: 'rgba(148,163,184,0.5)' }}>
          {links.length === 0 ? 'Loadingâ¦' :
            `Links ${rangeFrom}â${rangeTo} of ${filtered.length.toLocaleString()}${search.trim() !== '' ? ` (filtered from ${links.length.toLocaleString()})` : ''} Â· ${ADT_PROJECTION_YEARS.length} years (${ADT_PROJECTION_YEARS[0]}â${ADT_PROJECTION_YEARS[ADT_PROJECTION_YEARS.length - 1]}) Â· ${VC_CLASSES.length} vehicle classes â click a row to expand class breakdown`}
        </div>
        <input
          value={search}
          onChange={e => { setSearch(e.target.value); setPage(0); }}
          placeholder="Search link ID or road nameâ¦"
          style={{
          ...
          <tbody>
            {pageLinks.length === 0 && (
              <tr><td colSpan={3 + ADT_PROJECTION_YEARS.length} style={{ padding: '18px 14px', fontSize: 10, color: 'rgba(148,163,184,0.5)', textAlign: 'center' }}>
                {links.length === 0 ? 'Loading network linksâ¦' : 'No links match your search.'}
              </td></tr>
            )}
              ...
              const mainRow = (
                <tr key={link.link_id} onClick={() => toggleExpand(link.link_id)}
                  ...
                  <Td mono style={{ color: C.teal, fontWeight: 700, whiteSpace: 'nowrap' }}>
                    <span style={{ display: 'inline-block', width: 12, color: 'rgba(148,163,184,0.6)' }}>{isOpen ? 'â¾' : 'â¸'}</span>
                    {link.link_id}
                  </Td>
                  <Td style={{ color: 'rgba(226,232,240,0.85)', whiteSpace: 'nowrap' }}>{link.link_name ?? 'â'}</Td>
                ...
                <tr key={`${link.link_id}-expand`} style={{ background: 'rgba(0,245,255,0.03)' }}>
                  <td colSpan={3 + ADT_PROJECTION_YEARS.length} style={{ padding: '8px 14px 12px', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
                    <div style={{ fontSize: 8, color: 'rgba(148,163,184,0.55)', marginBottom: 6 }}>
                      Vehicle-class breakdown â base AADT {link.base_aadt.toLocaleString()} ({link.base_year}), projected per-class via <code>projectAADTByClass</code>
                    </div>
      ...
      <div style={{
        ...
        <div style={{ fontSize: 9, color: 'rgba(148,163,184,0.6)' }}>
          {filtered.length === 0 ? 'No links' : `Links ${rangeFrom}â${rangeTo} of ${filtered.length.toLocaleString()}`} Â· Page {safePage + 1} of {pageCount}
        </div>
...
export default function TabularSummaries() {
  ...
  // GeoJSON road links â loaded once on mount for tbl-links-full
  ...
  // ââ Anchor scrolling: when navigated via SourceTableButton, scroll to #tbl-NNN
  useEffect(() => {
  ...
  return (
    <div style={{ padding: '20px 24px', color: '#e2e8f0', minHeight: '100%' }}>
      <SectionHeader
        ...
        title="Sources & Evidence â Data Hub"
        sub="104 tables Â· all rows visible Â· Â§21 Global RMS Case Studies Â· Â§22 B-Standards Â· Â§23 C-Research Â· Â§24 GeoJSON Links"
        accent={C.cyan}
      />

      {/* ââ Network Coverage banner ââ */}
      <div style={{
      ...
      {/* ââ DATA TABLES TAB ââââââââââââââââââââââââââââââââââââââââââââââââââââ */}
      {tab === 'tables' && (
        <div>
          ...
          {/* ââ SECTION 1: ROAD NETWORK âââ */}
          ...
          <TablePanel id="tbl-001" title="National Road Network Summary" accent={C.cyan}
            ...
            chartTab="roadnetwork" chartLabel="ð Network Map â">
          ...
          <TablePanel id="tbl-002" title="Road Links by Class (DNR GIS Jun 2025)" accent={C.cyan}
            ...
            chartTab="roadnetwork" chartLabel="ð Class Map â">
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
          ...
          <TablePanel id="tbl-003" title="Road Network by Maintenance Region" accent={C.blue}
            source="network2026.geojson â maintena_1 field" onNavigate={navigate}
            chartTab="roadnetwork" chartLabel="ð Regional Map â">
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
          ...
          <TablePanel id="tbl-004" title="Paved Network by Pavement Type" accent={C.teal}
            ...
            chartTab="roadcondition" chartLabel="ð Condition â">
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
          ...
          {/* tbl-005 */}
          <TablePanel id="tbl-005" title="Historical Road Network Growth (1986â2026)" accent={C.purple}
            source="Department of National Roads WTSS / Annual Monitoring Reports" onNavigate={navigate}
            chartTab="networkstory" chartLabel="ð Network Story â">
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
          ...
          <div style={{ fontSize: 10, fontWeight: 900, color: C.green, textTransform: 'uppercase',
            ...
            Â§ 2 â Road Condition
          </div>

          {/* tbl-006 */}
          <TablePanel id="tbl-006" title="Road Condition Distribution â Paved Network (NAPR July 2025)" accent={C.green}
            source="NAPR Jul 2025 â IRI-based, paved network only" onNavigate={navigate}
            chartTab="roadcondition" chartLabel="ð Condition Map â">
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <Td mono align="right"><span style={{ color:'#94a3b8' }}>â</span></Td>
          ...
          <TablePanel id="tbl-007" title="Condition by Maintenance Region (% of paved links)" accent={C.green}
            ...
            chartTab="roadcondition" chartLabel="ð Regional Chart â">
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
          ...
          <div style={{ fontSize: 10, fontWeight: 900, color: C.yellow, textTransform: 'uppercase',
            ...
            Â§ 3 â Traffic & Demand
          </div>

          {/* tbl-008 */}
          <TablePanel id="tbl-008" title="Top 10 Road Links by AADT 2025 (TIS)" accent={C.yellow}
            source="TIS 2025 â Annual Monitoring Report" onNavigate={navigate}
            chartTab="traffic" chartLabel="ð Traffic Map â">
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
          ...
          {/* tbl-009 */}
          <TablePanel id="tbl-009" title="Vehicle Class Distribution â National Average (TIS 2025)" accent={C.yellow}
            source="TIS 2025 Annual Monitoring Report" onNavigate={navigate}
            chartTab="trafficanalytics" chartLabel="ð Analytics â">
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
          ...
          <TablePanel id="tbl-010" title="ATC Permanent Count Stations (New 2025 Deployment)" accent={C.yellow}
            source="ATC 2026 â 10 new stations U0001âU0010" onNavigate={navigate}
            chartTab="trafficanalytics" chartLabel="ð Analytics â">
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
          ...
          <TablePanel id="tbl-011" title="Bridge Inventory by Structural Type (BMS 2025)" accent={C.blue}
            ...
            chartTab="bms" chartLabel="ð BMS â">
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
              ...
              <tbody>
                ...
                <tr style={{ borderTop:'1px solid rgba(255,255,255,0.1)' }}>
                  ...
                  <Td mono align="right"><strong>546</strong></Td>
                  <Td/><Td/>
                </tr>
              </tbody>
            </table>
          ...
          <TablePanel id="tbl-012" title="Bridge Condition by Region (BMS 2024, % of structures)" accent={C.blue}
            ...
            chartTab="bms" chartLabel="ð BMS Analytics â">
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
          ...
          {/* ââ SECTION 5: OPRC / PROJECTS âââ */}
          ...
          <TablePanel id="tbl-013" title="OPRC Lot Performance Summary (FY 2025/26)" accent={C.purple}
            ...
            chartTab="oprc" chartLabel="ð OPRC Dashboard â">
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
          ...
          <TablePanel id="tbl-014" title="NDP IV Road Projects (Active 2025/26)" accent={C.purple}
            ...
            chartTab="ndpiv" chartLabel="ð NDPIV Dashboard â">
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
          ...
          <div style={{ fontSize: 10, fontWeight: 900, color: C.orange, textTransform: 'uppercase',
            ...
            Â§ 6 â Infrastructure Overlays
          </div>

          {/* tbl-015 */}
          <TablePanel id="tbl-015" title="Department of National Roads Maintenance Stations (MS01âMS23)" accent={C.orange}
          ...
          {/* tbl-016 */}
          <TablePanel id="tbl-016" title="Weighbridges â Location & Operational Status" accent={C.orange}
            source="new_weigh_bridges.geojson (public/data/)" onNavigate={navigate}
            chartTab="overloading" chartLabel="ð Overloading â">
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
              ...
              <tbody>
                {WEIGHBRIDGES.map(r => (
                  <tr key={r.id}><Td mono><span style={{ color:C.orange }}>{r.id}</span></Td>
                    ...
                    <Td mono align="right">{r.daily_trucks || 'â'}</Td>
                  </tr>
                ))}
              </tbody>
            </table>
          ...
          {/* tbl-019 */}
          <TablePanel id="tbl-019" title="Rail Network â Existing & Proposed" accent={C.teal}
          ...
          {/* ââ SECTION 7: BUDGET & MAINTENANCE âââ */}
          <div style={{ fontSize: 10, fontWeight: 900, color: C.pink, textTransform: 'uppercase',
            ...
            Â§ 7 â Budget & Maintenance Backlog
          </div>

          {/* tbl-020 */}
          <TablePanel id="tbl-020" title="Road Maintenance Budget Allocation by Work Type (Bn UGX)" accent={C.pink}
            source="Department of National Roads Annual Budget Estimates 2022â2026" onNavigate={navigate}
            chartTab="budget" chartLabel="ð Budget â">
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
          ...
          {/* ââ SECTION 8: ML PREDICTIONS âââ */}
          <div style={{ fontSize: 10, fontWeight: 900, color: '#a855f7', textTransform: 'uppercase',
            ...
            Â§ 8 â ML Predictions & Analytics
          </div>

          {/* tbl-022 */}
          <TablePanel id="tbl-022" title="ML Predicted Pavement Condition â Sample Links" accent="#a855f7"
            source="deep_ml_engine.py output / bot_results.json" onNavigate={navigate}
            chartTab="mlarchitecture" chartLabel="ð ML System â">
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
              <thead><tr><Th>Link ID</Th><Th>Pred. IRI (m/km)</Th><Th>Rutting (mm)</Th><Th>Cracking (%)</Th><Th>Urgency (0â10)</Th><Th>Anomaly</Th></tr></thead>
              <tbody>
                {ML_PREDICTIONS.map(r => (
                  <tr key={r.link_id}><Td mono><span style={{ color:C.cyan }}>{r.link_id}</span></Td>
                    ...
                    <Td><span style={{ color:r.anomaly?'#ef4444':'#22c55e' }}>{r.anomaly?'â  Yes':'No'}</span></Td>
                  </tr>
                ))}
              </tbody>
            </table>
          ...
          {/* ââ Â§9: Axle Load & Overloading âââââââââââââââââââââââââââââââââââââ */}
          <SectionHeader icon={<Truck size={15} style={{ color: C.orange }}/>} accent={C.orange}
            title="Axle Load & Overloading" sub="Department of National Roads weighbridge network Â· EACU enforcement data Â· 2024/25"/>
          {/* tbl-023 */}
          <TablePanel id="tbl-023" title="Overloading Statistics by Weighbridge (daily averages 2024/25)" accent={C.orange} source="EACU weighbridge records" chartTab="overloading" chartLabel="ð Overloading â" onNavigate={navigate}>
          ...
          {/* tbl-024 */}
          <TablePanel id="tbl-024" title="Overloading by Vehicle Class â % Exceeding 8t Single-Axle Limit" accent={C.orange} source="EACU / WIM sensors">
          ...
          {/* tbl-025 */}
          <TablePanel id="tbl-025" title="Annual Overloading Enforcement Statistics 2019â2025" accent={C.orange} source="EACU annual reports">
          ...
          {/* ââ Â§10: Road Safety âââââââââââââââââââââââââââââââââââââââââââââââââ */}
          <SectionHeader icon={<Shield size={15} style={{ color: C.red }}/>} accent={C.red}
            title="Road Safety" sub="UNRA / Uganda Police Force accident statistics Â· National Road Safety Authority Â· 2025"/>
          {/* tbl-029 */}
          ...
          {/* tbl-033 */}
          <TablePanel id="tbl-033" title="Fatal Accident Trend 2019â2025 (National Roads)" accent={C.red} source="Uganda Police Force annual reports">
          ...
          {/* tbl-034 */}
          <TablePanel id="tbl-034" title="Speed Management Zones â National Road Network 2025" accent={C.red} source="DNR traffic engineering">
          ...
          {/* ââ Â§11: Maintenance Works ââââââââââââââââââââââââââââââââââââââââââââ */}
          <SectionHeader icon={<Wrench size={15} style={{ color: C.teal }}/>} accent={C.teal}
            title="Maintenance Works" sub="Routine, periodic and emergency maintenance Â· DNR maintenance regions Â· FY 2024/25"/>
          {/* tbl-035 */}
          ...
          {/* tbl-036 */}
          <TablePanel id="tbl-036" title="Emergency Works Responses 2024â2025" accent={C.teal} source="DNR emergency works register">
          ...
          {/* tbl-038 */}
          <TablePanel id="tbl-038" title="Pavement Surface Distress Types â NAPR Survey Sample" accent={C.teal} source="NAPR 2025 survey data">
          ...
          {/* tbl-039 */}
          <TablePanel id="tbl-039" title="Drainage & Vegetation Maintenance â National Network 2024/25" accent={C.teal} source="DNR maintenance operations">
          ...
          <TablePanel id="tbl-040" title="Pothole Repair Programme by Region (FY 2024/25)" accent={C.teal} source="DNR force account records">
            <table style={{ width:'100%', borderCollapse:'collapse' }}><thead><tr><Th>Region</Th><Th>Potholes Patched</Th><Th>mÂ² Patched</Th><Th>Cost (M UGX)</Th><Th>Avg Cost / mÂ² (UGX)</Th></tr></thead>
          ...
          {/* ââ Â§12: Link Lifecycle âââââââââââââââââââââââââââââââââââââââââââââââ */}
          <SectionHeader icon={<Clock size={15} style={{ color: C.purple }}/>} accent={C.purple}
            title="Link Lifecycle & Asset Age" sub="Pavement lifecycle management Â· HDM-4 trigger analysis Â· DNR asset registry 2025"/>
          {/* tbl-041 */}
          <TablePanel id="tbl-041" title="Links Scheduled for Treatment 2025â2027 (HDM-4 Triggered)" accent={C.purple} source="DNR lifecycle management system">
          ...
          {/* tbl-042 */}
          <TablePanel id="tbl-042" title="Rehabilitation History by Road Class (2015â2025)" accent={C.purple} source="DNR project records">
          ...
          {/* tbl-043 */}
          <TablePanel id="tbl-043" title="Pavement Age Distribution â Paved Network 2025" accent={C.purple} source="DNR road inventory / pave year data">
            <table style={{ width:'100%', borderCollapse:'collapse' }}><thead><tr><Th>Age Band</Th><Th>km</Th><Th>% of Paved</Th><Th>Avg Condition Index (0â100)</Th></tr></thead>
          ...
          {/* tbl-045 */}
          <TablePanel id="tbl-045" title="Asset Replacement Forecast 2026â2035" accent={C.purple} source="DNR long-term maintenance plan">
          ...
          {/* ââ Â§13: Environmental & Climate âââââââââââââââââââââââââââââââââââââ */}
          <SectionHeader icon={<Leaf size={15} style={{ color: C.green }}/>} accent={C.green}
            title="Environmental & Climate Resilience" sub="Climate hazard mapping Â· carbon tracking Â· flood vulnerability Â· DNR environment unit 2025"/>
          {/* tbl-047 */}
          <TablePanel id="tbl-047" title="Climate Hazard Exposure â National Road Network 2025" accent={C.green} source="DNR climate risk assessment / NEMA data">
          ...
          {/* tbl-048 */}
          <TablePanel id="tbl-048" title="Flood-Prone Road Links â Annual Closure Risk" accent={C.green} source="DNR hydrology surveys / district reports">
          ...
          <TablePanel id="tbl-050" title="Carbon Emissions by Maintenance Activity Type" accent={C.green} source="DNR environment unit / IPCC emission factors">
            <table style={{ width:'100%', borderCollapse:'collapse' }}><thead><tr><Th>Activity</Th><Th>Unit</Th><Th>t COâe</Th><Th>Scope</Th></tr></thead>
          ...
          {/* tbl-051 */}
          <TablePanel id="tbl-051" title="Environmental Mitigation Works â National Roads 2024/25" accent={C.green} source="DNR environment & social unit">
          ...
          {/* ââ Â§14: Cross-border Corridors ââââââââââââââââââââââââââââââââââââââ */}
          <SectionHeader icon={<Route size={15} style={{ color: C.blue }}/>} accent={C.blue}
            title="Cross-border Transport Corridors" sub="Northern, Central & Western Corridors Â· border traffic Â· transit time Â· TradeMark East Africa data"/>
          {/* tbl-053 */}
          <TablePanel id="tbl-053" title="Northern Corridor Road Segments â Mombasa to Kigali" accent={C.blue} source="TradeMark East Africa / corridor authorities">
          ...
          {/* tbl-054 */}
          <TablePanel id="tbl-054" title="Central Corridor Road Segments â Dar es Salaam to Kampala" accent={C.blue} source="Tanzania NRA / Uganda DNR / TradeMark">
            <table style={{ width:'100%', borderCollapse:'collapse' }}><thead><tr><Th>Segment</Th><Th>km</Th><Th>Country</Th><Th>Condition</Th><Th>% Paved</Th></tr></thead>
          ...
          {/* tbl-058 */}
          <TablePanel id="tbl-058" title="Border Post Infrastructure â One-Stop Border Post Status 2025" accent={C.blue} source="East African Community / TradeMark">
            ...
            <tbody>{BORDER_INFRA.map(r=><tr key={r.post}><Td>{r.post}</Td><Td><span style={{ color:r.osbp?C.green:C.red }}>{r.osbp?'Yes':'No'}</span></Td><Td align="right" mono>{r.scanners}</Td><Td align="right" mono>{r.lanes}</Td><Td align="right" mono>{r.parking_trucks}</Td><Td mono>{r.yr ?? 'â'}</Td></tr>)}</tbody></table>
          </TablePanel>

          {/* ââ Â§15: Socioeconomic Impact âââââââââââââââââââââââââââââââââââââââââ */}
          <SectionHeader icon={<Users size={15} style={{ color: C.yellow }}/>} accent={C.yellow}
            title="Socioeconomic Impact" sub="Population & agricultural access Â· rural accessibility Â· health & education road access Â· UBOS data 2024"/>
          {/* tbl-059 */}
          <TablePanel id="tbl-059" title="Population Served by Road Network â Regional Summary (2024)" accent={C.yellow} source="UBOS 2024 projections / DNR GIS">
          ...
          <TablePanel id="tbl-060" title="Agricultural Market Access Index by Region" accent={C.yellow} source="Ministry of Agriculture / UBOS 2024">
            <table style={{ width:'100%', borderCollapse:'collapse' }}><thead><tr><Th>Region</Th><Th>Farmland (kmÂ²)</Th><Th>Paved Access %</Th><Th>Gravel Access %</Th><Th>No Road %</Th></tr></thead>
          ...
          {/* tbl-061 */}
          <TablePanel id="tbl-061" title="Rural Access Index by Region (RAI â % rural pop within 2 km all-weather road)" accent={C.yellow} source="World Bank / UBOS Rural Access Index">
          ...
          {/* ââ Â§16: International Benchmarking ââââââââââââââââââââââââââââââââââ */}
          <SectionHeader icon={<Globe size={15} style={{ color: C.teal }}/>} accent={C.teal}
            title="International Benchmarking" sub="EAC member states Â· Sub-Saharan Africa comparison Â· World Bank SSATP thresholds"/>
          {/* tbl-064 */}
          <TablePanel id="tbl-064" title="East African Community â Road Network Comparison 2024" accent={C.teal} source="World Bank / national road authorities 2024">
            <table style={{ width:'100%', borderCollapse:'collapse' }}><thead><tr><Th>Country</Th><Th>Road km</Th><Th>Paved km</Th><Th>Paved %</Th><Th>Population (M)</Th><Th>Density / kmÂ²</Th></tr></thead>
          ...
          {/* tbl-065 */}
          <TablePanel id="tbl-065" title="Sub-Saharan Africa â Paved Share & Condition Comparison" accent={C.teal} source="SSATP / World Bank Africa Infrastructure Diagnostic 2024">
          ...
          {/* tbl-066 */}
          <TablePanel id="tbl-066" title="Road Density Comparison â km per 1,000 kmÂ² of territory" accent={C.teal} source="World Bank / national road agencies 2024">
            <table style={{ width:'100%', borderCollapse:'collapse' }}><thead><tr><Th>Country</Th><Th>Area (kmÂ²)</Th><Th>Road km</Th><Th>Density / 1,000 kmÂ²</Th></tr></thead>
          ...
          {/* tbl-067 */}
          <TablePanel id="tbl-067" title="Road Maintenance Expenditure Comparison â USD per km 2023" accent={C.teal} source="Sub-Saharan Africa Transport Policy Programme 2023">
          ...
          {/* tbl-068 */}
          <TablePanel id="tbl-068" title="Road Condition Benchmarks â SSATP IRI Standards vs Uganda" accent={C.teal} source="SSATP / World Bank IRI thresholds">
          ...
          {/* tbl-069 */}
          <TablePanel id="tbl-069" title="Traffic Volume Benchmarks by Route Type â EAC / SSA Comparison" accent={C.teal} source="World Bank EAC transport study 2024">
          ...
          {/* ââ Â§17: Asset Valuation ââââââââââââââââââââââââââââââââââââââââââââââ */}
          <SectionHeader icon={<DollarSign size={15} style={{ color: C.green }}/>} accent={C.green}
            title="Asset Valuation" sub="Road & bridge asset replacement values Â· depreciation Â· capital stock accumulation Â· DNR asset management 2025"/>
          {/* tbl-070 */}
          ...
          {/* tbl-073 */}
          <TablePanel id="tbl-073" title="Capital Stock Accumulation â Uganda National Road Network 2000â2025" accent={C.green} source="DNR / MoWT infrastructure accounts">
          ...
          {/* tbl-074 */}
          <TablePanel id="tbl-074" title="Annual Road Asset Consumption vs Budget Coverage 2021â2025" accent={C.green} source="DNR / MoWT annual accounts">
          ...
          {/* ââ Â§18: Data Quality & Audit âââââââââââââââââââââââââââââââââââââââââ */}
          ...
          {/* tbl-077 */}
          <TablePanel id="tbl-077" title="Condition Survey Coverage by Region (2024 NAPR Survey)" accent={C.pink} source="NAPR survey completion register 2024" chartTab="dataaudit" chartLabel="ð Data Audit â" onNavigate={navigate}>
          ...
          {/* tbl-078 */}
          <TablePanel id="tbl-078" title="Data Vintage by Dataset â Uganda National Roads Platform" accent={C.pink} source="DNR data management unit 2025">
          ...
          {/* tbl-079 */}
          <TablePanel id="tbl-079" title="Known Data Gaps â National Roads Platform 2025" accent={C.pink} source="DNR data audit / platform QA">
          ...
          {/* tbl-080 */}
          <TablePanel id="tbl-080" title="KPI Cross-Validation â Platform vs Official Statistics" accent={C.pink} source="DNR / DataAuditEngine automated check" chartTab="dataaudit" chartLabel="ð Data Audit â" onNavigate={navigate}>
            ...
            <tbody>{KPI_VALIDATION.map(r=><tr key={r.kpi}><Td>{r.kpi}</Td><Td mono style={{ color:C.cyan, fontWeight:700 }}>{r.value}</Td><Td style={{ color:'rgba(148,163,184,0.5)' }}>{r.source}</Td><Td mono>{r.geojson}</Td><Td mono>{r.delta}</Td><Td><span style={{ color:r.ok?C.green:'#ef4444' }}>{r.ok?'â OK':'â FAIL'}</span></Td></tr>)}</tbody></table>
          </TablePanel>
          {/* tbl-081 */}
          <TablePanel id="tbl-081" title="Duplicate Link & Geometry Check Results â DNR GIS QA" accent={C.pink} source="DNR GIS QA automated audit">
          ...
          {/* ââ Â§19: Construction & Rehabilitation âââââââââââââââââââââââââââââââ */}
          <SectionHeader icon={<HardHat size={15} style={{ color: C.orange }}/>} accent={C.orange}
            title="Construction & Rehabilitation" sub="Active contracts Â· procurement timelines Â· contractor performance Â· FY 2024/25"/>
          {/* tbl-082 */}
          <TablePanel id="tbl-082" title="Active Road Construction Contracts (FY 2024/25)" accent={C.orange} source="DNR contracts department" chartTab="projecttracker" chartLabel="ð Projects â" onNavigate={navigate}>
          ...
          {/* tbl-083 */}
          <TablePanel id="tbl-083" title="Completed Road Rehabilitation by Financial Year 2020â2025" accent={C.orange} source="DNR project completion records">
          ...
          {/* tbl-084 */}
          <TablePanel id="tbl-084" title="New Road Construction by Year 2015â2025 (km and Investment)" accent={C.orange} source="DNR statistics / MoWT investment data">
          ...
          {/* tbl-086 */}
          <TablePanel id="tbl-086" title="Procurement Timeline Statistics â DNR Road Works Contracts 2024/25" accent={C.orange} source="DNR procurement department">
            ...
            <tbody>{PROCUREMENT_TIMELINE.map(r=><tr key={r.stage}><Td>{r.stage}</Td><Td align="right" mono style={{ color:C.orange }}>{r.avg_wks}</Td><Td align="right" mono style={{ color:C.green }}>{r.best_wks}</Td><Td align="right" mono style={{ color:'rgba(148,163,184,0.4)' }}>{r.legal_min ?? 'â'}</Td></tr>)}</tbody></table>
          </TablePanel>
          {/* tbl-087 */}
          <TablePanel id="tbl-087" title="Design Standards Compliance â National Road Projects 2024" accent={C.orange} source="DNR quality assurance unit 2024">
          ...
          {/* ââ Â§20: Connectivity & Accessibility ââââââââââââââââââââââââââââââââ */}
          <SectionHeader icon={<Network size={15} style={{ color: C.cyan }}/>} accent={C.cyan}
            title="Network Connectivity & Accessibility" sub="District connections Â· all-weather access Â· travel time matrix Â· critical links Â· urban roads"/>
          {/* tbl-088 */}
          ...
          {/* tbl-090 */}
          <TablePanel id="tbl-090" title="Inter-Regional Travel Time Matrix â Kampala to Major Cities (2025)" accent={C.cyan} source="DNR travel time survey 2025">
          ...
          {/* tbl-091 */}
          <TablePanel id="tbl-091" title="Connectivity Gaps â Poor-Access Corridors Affecting Communities" accent={C.cyan} source="DNR accessibility assessment 2025">
          ...
          {/* tbl-092 */}
          <TablePanel id="tbl-092" title="Urban Road Network Statistics â Major Urban Centres 2025" accent={C.cyan} source="DNR / KCCA / urban authorities">
          ...
          {/* tbl-094 */}
          <TablePanel id="tbl-094" title="Oil Sector Road Connectivity â Albertine Graben Network" accent={C.cyan} source="Ministry of Energy / DNR / TotalEnergies access roads">
          ...
          {/* tbl-095 */}
          <TablePanel id="tbl-095" title="Network Resilience Indicators â DNR Risk Assessment 2025" accent={C.cyan} source="DNR network resilience analysis 2025">
          ...
          {/* tbl-099 */}
          <TablePanel id="tbl-099" title="Service Centre Road Access â Key Public Services 2025" accent={C.cyan} source="DNR / UBOS service centre proximity study 2025">
          ...
          {/* tbl-100 */}
          <TablePanel id="tbl-100" title="National Road Network Completeness Index 2025" accent={C.cyan} source="DNR data management / platform QA summary" chartTab="dataaudit" chartLabel="ð Data Audit â" onNavigate={navigate}>
          ...
          {/* ââ SECTION 21: GLOBAL RMS CASE STUDIES âââ */}
          <div style={{ fontSize: 10, fontWeight: 900, color: C.green, textTransform: 'uppercase',
            letterSpacing: '0.12em', marginBottom: 10, marginTop: 20,
            borderBottom: '1px solid rgba(0,255,136,0.1)', paddingBottom: 6 }}>
            Â§21 â Global RMS Case Studies (15 Countries)
          </div>
          {/* tbl-101 */}
          <TablePanel id="tbl-101" title="Global RMS Case Studies â All 15 Countries Analysed" accent={C.green}
            source="DNR RMS research synthesis (Jun 2026) â RMS section case studies" chartTab="rms" chartLabel="ð View in RMS â" onNavigate={navigate}>
          ...
          {/* ââ SECTION 22: CATEGORY B STANDARDS âââ */}
          <div style={{ fontSize: 10, fontWeight: 900, color: C.blue, textTransform: 'uppercase',
            letterSpacing: '0.12em', marginBottom: 10, marginTop: 20,
            borderBottom: '1px solid rgba(77,159,255,0.1)', paddingBottom: 6 }}>
            Â§22 â International Standards & Frameworks (Category B â {CAT_B_STANDARDS.length} standards)
          </div>
          {/* tbl-102 */}
          <TablePanel id="tbl-102" title="Category B â International Standards, Guidelines & Manuals (All 20)" accent={C.blue}
            source="Sources Catalogue Category B Â· DNR platform evidence base" chartTab="sources" chartLabel="ð Sources â" onNavigate={navigate}>
            <table style={{ width:'100%', borderCollapse:'collapse', fontSize:9 }}>
              <thead><tr>
          ...
          {/* ââ SECTION 23: CATEGORY C RESEARCH âââ */}
          <div style={{ fontSize: 10, fontWeight: 900, color: C.purple, textTransform: 'uppercase',
            letterSpacing: '0.12em', marginBottom: 10, marginTop: 20,
            borderBottom: '1px solid rgba(185,103,255,0.1)', paddingBottom: 6 }}>
            Â§23 â Research Literature (Category C â {CAT_C_RESEARCH.length} papers)
          </div>
          {/* tbl-103 */}
          <TablePanel id="tbl-103" title="Category C â Global Research Papers & Studies (All 53)" accent={C.purple}
            source="Sources Catalogue Category C Â· DNR evidence base for ML, PMS, BMS, HDM4, Traffic modules" chartTab="sources" chartLabel="ð Sources â" onNavigate={navigate}>
            <table style={{ width:'100%', borderCollapse:'collapse', fontSize:9 }}>
              <thead><tr>
          ...
          {/* ââ SECTION 24: GEOJSON ROAD LINKS âââ */}
          ...
          <TablePanel id="tbl-links-full" title="All Road Links from network2026.geojson â All Properties" accent={C.teal}
            ...
            <div style={{ padding:'8px 14px 4px', display:'flex', alignItems:'center', gap:10, flexWrap:'wrap' }}>
              <input
                ...
                placeholder="Search link_id or road nameâ¦"
                style={{
              ...
              <span style={{ fontSize:9, color:'rgba(148,163,184,0.4)' }}>
                {geoLinks.length === 0 ? 'Loadingâ¦' :
                  `Showing ${geoLinks.filter(p => !linkSearch || String(p.link_id).toLowerCase().includes(linkSearch.toLowerCase()) || String(p.link_nam_1 ?? '').toLowerCase().includes(linkSearch.toLowerCase())).length.toLocaleString()} / ${geoLinks.length.toLocaleString()} links Â· 21,160 km mapped Â· Official: 21,302 km Â· Gap: 142 km`}
              </span>
            </div>
                    ...
                    .map((p, i) => {
                      ...
                      return (
                        <tr key={String(p.link_id)} style={{ background: i%2===0?'rgba(15,23,42,0.35)':'transparent', borderBottom:'1px solid rgba(255,255,255,0.02)' }}>
                          ...
                          <Td style={{ maxWidth:200, overflow:'hidden', textOverflow:'ellipsis', whiteSpace:'nowrap' }}>{String(p.link_nam_1 ?? 'â')}</Td>
                          <Td mono style={{ color:'rgba(148,163,184,0.6)', whiteSpace:'nowrap' }}>{String(p.road_no ?? 'â')}</Td>
                          <Td align="center" style={{ color:clsColor[cls]??'#94a3b8', fontWeight:800 }}>{cls}</Td>
                          <Td align="right" mono>{km.toFixed(2)}</Td>
                          <Td style={{ color: String(p.surface_ty) === 'Bituminous' ? C.cyan : C.orange, fontSize:8 }}>{String(p.surface_ty ?? 'â')}</Td>
                          <Td style={{ color:'rgba(148,163,184,0.7)', whiteSpace:'nowrap', fontSize:8 }}>{String(p.maintena_1 ?? 'â')}</Td>
                          <Td style={{ color:'rgba(148,163,184,0.5)', fontSize:8 }}>{String(p.maintenanc ?? 'â')}</Td>
                          <Td align="center" mono style={{ color:'rgba(148,163,184,0.5)' }}>{p.completion ? String(p.completion) : 'â'}</Td>
                          <Td align="center" mono style={{ color:'rgba(148,163,184,0.4)' }}>{p.rehabilita ? String(p.rehabilita) : 'â'}</Td>
                        </tr>
                      );
                    })}
                </tbody>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '10px 14px',
            ...
            <span style={{ fontSize: 10, color: 'rgba(148,163,184,0.7)' }}>
              Geospatial exports (Shapefile, GeoJSON, KML, CSV) â{' '}
      ...
      {/* ââ DOCUMENTS TAB ââââââââââââââââââââââââââââââââââââââââââââââââââââââ */}
      {tab === 'documents' && (
        <Suspense fallback={<div style={{ padding: 40, color: '#64748b', textAlign: 'center' }}>Loadingâ¦</div>}>
          <DocumentStore />
        </Suspense>
      )}

      {/* ââ DOWNLOADS TAB ââââââââââââââââââââââââââââââââââââââââââââââââââââââ */}
      {tab === 'downloads' && (
        <Suspense fallback={<div style={{ padding: 40, color: '#64748b', textAlign: 'center' }}>Loadingâ¦</div>}>
          <DownloadsView />
        </Suspense>
