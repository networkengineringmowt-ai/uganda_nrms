  ...
  return (
    <div style={{ position: 'relative', background: C.bg, borderRadius: 16,
      ...
      {selected && (
        ...
        <div style={{background:'rgba(168,85,247,0.04)',border:'1px solid rgba(168,85,247,0.14)',borderRadius:10,padding:'10px 16px',marginBottom:16,display:'flex',alignItems:'center',gap:10,flexWrap:'wrap'}}>
          <span style={{fontSize:15,fontWeight:800,color:'rgba(168,85,247,1)',letterSpacing:-0.3}}>ML Architecture & AI Pipeline</span>
