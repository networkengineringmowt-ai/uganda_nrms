      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '28px 28px 60px' }}>
        ...
        <div style={{ marginBottom: 32 }}>
          ...
          <div style={{
            ...
            paddingBottom: 12, borderBottom: `1px solid rgba(${hexRgb(C.orange)},0.15)`,
          }}>
            <div style={{
              width: 38, height: 38, borderRadius: 11, flexShrink: 0,
              background: `linear-gradient(135deg, rgba(${hexRgb(C.orange)},0.25), rgba(${hexRgb(C.pink)},0.1))`,
              border: `1px solid rgba(${hexRgb(C.orange)},0.45)`,
              display: 'flex', alignItems: 'center', justifyContent: 'center',
              boxShadow: `0 0 24px rgba(${hexRgb(C.orange)},0.25)`,
            }}>
              <Camera size={17} style={{ color: C.orange }} />
            </div>
            <div>
