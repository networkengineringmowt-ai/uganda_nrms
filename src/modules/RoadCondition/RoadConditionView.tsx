  ...
  return (
    <div style={{ display:'flex', flexDirection:'column', height:'100%', overflow:'hidden', background:'#0a0f1e' }}>
      ...
      <div style={{
        ...
        <b style={{ color: '#fff' }}>21,302 km</b> Â· <b style={{ color: '#22c55e' }}>6,405 paved (30.1%)</b> Â· <b style={{ color: '#f59e0b' }}>14,897 unpaved</b> Â· GeoJSON <b style={{ color: '#fff' }}>21,160 km / 1,013 links</b> Â· <b style={{ color: '#fb923c' }}>142 km gap</b>
      </div>
