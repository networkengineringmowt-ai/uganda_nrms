/**
 * MindMapSection ÃÂ¢ÃÂÃÂ Platform Data Pipeline Workflow
 ...
 * Unified DB (41 tables ÃÂ¢ÃÂÃÂ see supabase_schema.sql). The Algorithms / Queries /
 ...
 * PMS, BMS, TIS, ÃÂ¢ÃÂÃÂ¦) consumes the hub via SourceTableButton.
 */
import { useState, useRef, useCallback, useMemo, useLayoutEffect } from 'react';
import { ZoomIn, ZoomOut, RotateCcw, X } from 'lucide-react';

// ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Types ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
...
// ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Node data ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ

const NODES: Node[] = [
  // ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ L1 ÃÂ¢ÃÂÃÂ Triggers (x=40) ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
  { id:'trig-daily',   label:'Schedule Trigger',     sub:'Daily 06:00 EAT',           layer:1, x: 40,  y:130,  w:150, h:68, color:'#10b981',
    detail:'Runs every day at 06:00 EAT via cron. Fires the Python ETL chain in sequence: DB export ÃÂ¢ÃÂÃÂ analytics ÃÂ¢ÃÂÃÂ ML update ÃÂ¢ÃÂÃÂ Supabase upsert ÃÂ¢ÃÂÃÂ deploy.' },
  ...
  { id:'trig-entry',   label:'Data-Entry Writes',     sub:'service_role server',        layer:1, x: 40,  y:340,  w:150, h:68, color:'#22d3ee',
    detail:'server/index.js ÃÂ¢ÃÂÃÂ trusted local write-back server. Field staff submit condition surveys, encroachment reports, road-reserve usage permits (MOWT Form 2), bridge inspections, work orders. Uses the Supabase service_role key to write privileged rows into the Unified DB (allowlisted tables only).' },

  // ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ L2 ÃÂ¢ÃÂÃÂ Processing (x=250) ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
  { id:'proc-export',  label:'DB Export / ETL',       sub:'Python ÃÂÃÂ· upload_to_supabase',layer:2, x:250,  y:130,  w:155, h:68, color:'#3b82f6',
    detail:'scripts/etl/ingest_all_sources.py + upload_to_supabase.py ÃÂ¢ÃÂÃÂ reads ROMDAS MDB/CSV/xlsx, FWD xlsx, Maintenance plans, HDM4 network, Committed Projects; upserts into the Supabase Unified DB (41 tables).' },
  { id:'proc-analytics',label:'Analytics Engine',    sub:'Regional ÃÂÃÂ· Budget ÃÂÃÂ· ESAL',   layer:2, x:250,  y:235,  w:155, h:68, color:'#8b5cf6',
    detail:'compute_overloading.py, compute_growth_factors.py, build_master.py ÃÂ¢ÃÂÃÂ generate ESAL risk scores, AADT growth factors, condition summaries, and budget alignment KPIs written back to the Unified DB.' },
  ...
  // ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ L3 ÃÂ¢ÃÂÃÂ Agents (x=470) ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
  { id:'ag-ml',        label:'ML Model Agent',        sub:'PyTorch DNN ÃÂÃÂ· GNN',          layer:3, x:470,  y:130,  w:150, h:68, color:'#f59e0b',
    detail:'deep_ml_engine.py ÃÂ¢ÃÂÃÂ multi-task DNN predicts IRI, rutting, cracking, urgency. GNN smooths predictions across network neighbours. IsolationForest detects anomalies. Results land in ml_model_metrics / link_iri_predictions.' },
  { id:'ag-qc',        label:'QC Validation',         sub:'Schema ÃÂÃÂ· Range checks',      layer:3, x:470,  y:235,  w:150, h:68, color:'#ec4899',
    detail:'Validates each ingested record: range checks on IRI (0ÃÂ¢ÃÂÃÂ25), deflections (0ÃÂ¢ÃÂÃÂ5000ÃÂÃÂµm), GPS coordinates within Uganda bbox, date plausibility. Flags bad records to data_quality_flags.' },
  { id:'ag-audit',     label:'Data Audit Engine',     sub:'Coverage ÃÂÃÂ· Freshness',       layer:3, x:470,  y:340,  w:150, h:68, color:'#06b6d4',
    detail:'DataAuditEngine.ts ÃÂ¢ÃÂÃÂ admin-only view. Checks which links have ROMDAS data, FWD, traffic counts, bridge inspections. Flags links with >3-year data gap.' },

  // ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ L4 ÃÂ¢ÃÂÃÂ Outputs (x=680) ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
  ...
  { id:'out-json',     label:'Public JSON Export',    sub:'central_network_db.json',    layer:4, x:680,  y:235,  w:160, h:68, color:'#14b8a6',
    detail:'export_unified_data.py writes public/data/*.json ÃÂ¢ÃÂÃÂ per-link IRI summaries, table counts, AADT, ML metrics for fast client-side reads. A cached mirror of the Unified DB.' },
  { id:'out-db',       label:'Unified DB ÃÂÃÂ· Supabase', sub:'Postgres ÃÂÃÂ· 41 tables',       layer:4, x:680,  y:340,  w:160, h:68, color:'#3ecf8e',
    detail:'Supabase Postgres (project vbidhkvzjigatfygnyc) ÃÂ¢ÃÂÃÂ the single source of truth. 41 tables across all layers: RMS, BMS, TIS, PMS, Road Reserve (incl. road_reserve_applications/applicants MOWT Form 2), AI/ML analytics, lifecycle, budgeting. Reads via the anon key (src/lib/supabase.ts); privileged writes via the service_role server. Schema: supabase_schema.sql.' },

  // ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ L5 ÃÂ¢ÃÂÃÂ Algorithms ÃÂÃÂ· Queries ÃÂÃÂ· Decision Trees (x=900) ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
  { id:'alg-engine',   label:'Algorithm Library',     sub:'HDM-4 ÃÂÃÂ· ESAL ÃÂÃÂ· LCCA',        layer:5, x:900,  y:165,  w:170, h:66, color:'#a78bfa',
  ...
  { id:'qry-views',    label:'SQL Views & Queries',   sub:'Supabase RPC ÃÂÃÂ· aggregates',  layer:5, x:900,  y:275,  w:170, h:66, color:'#38bdf8',
  ...
  { id:'dtree',        label:'Decision Trees',        sub:'rules ÃÂÃÂ· recommendations',    layer:5, x:900,  y:385,  w:170, h:66, color:'#fbbf24',
  ...
  // ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ L6 ÃÂ¢ÃÂÃÂ Data Hub (x=1130) ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
  { id:'tbl-hub',      label:'Tabular Summaries Hub', sub:'100 cited tables ÃÂÃÂ· Data Hub', layer:6, x:1130, y:355,  w:195, h:88, color:'#00f5ff',
    detail:'src/modules/Sources/TabularSummaries.tsx ÃÂ¢ÃÂÃÂ 100 tables sourced from the Unified DB plus official UNRA/MoWT/World Bank documents. Every table carries a source citation (tbl-001 ÃÂ¢ÃÂÃÂ¦ tbl-100) and is referenced across ALL platform sections via SourceTableButton. Now reads everything from the Supabase Unified DB.' },

  // ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ L7 ÃÂ¢ÃÂÃÂ Platform Sections (x=1390) ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
  { id:'sec-rms',      label:'RMS ÃÂ¢ÃÂÃÂ Road Network',    sub:'tbl 001ÃÂ¢ÃÂÃÂ005 ÃÂÃÂ· road_links',   layer:7, x:1390, y: 30,  w:180, h:50, color:'#00e5ff',
    detail:'RoadNetworkView.tsx / RMS ÃÂ¢ÃÂÃÂ 1,017 national-road links, classes A/B/C/M. tbl-001-005 (inventory, length by class/region, surface type). Source: road_links + road_link_condition.' },
  { id:'sec-reserve',  label:'Road Reserve Mgmt',     sub:'road_reserve_* ÃÂÃÂ· tbl 047ÃÂ¢ÃÂÃÂ050',layer:7, x:1390, y: 92,  w:180, h:50, color:'#00d4aa',
    detail:'RoadReserveSection.tsx ÃÂ¢ÃÂÃÂ gazette & legal status, encroachment register, reserve mapping, and Road Reserve Usage permits (MOWT Form 2). Source: road_reserve_records / _encroachments / _gazette / _applications / _applicants.' },
  { id:'sec-pms',      label:'PMS ÃÂ¢ÃÂÃÂ Condition',       sub:'tbl 006, 007, 038',          layer:7, x:1390, y:154,  w:180, h:50, color:'#fb923c',
    detail:'RoadConditionView.tsx ÃÂ¢ÃÂÃÂ IRI/condition/urgency map. tbl-006 (IRI by class), tbl-007 (paved condition 2024), tbl-038 (ML predictions).' },
  { id:'sec-bms',      label:'BMS ÃÂ¢ÃÂÃÂ Bridges',         sub:'tbl 011, 012, 072',          layer:7, x:1390, y:216,  w:180, h:50, color:'#4d9fff',
    detail:'BMSSection.tsx ÃÂ¢ÃÂÃÂ 546 bridges. tbl-011 (bridge inventory), tbl-012 (condition ratings 2024), tbl-072 (priority ranking). Source: structures + inspections.' },
  { id:'sec-tis',      label:'TIS ÃÂ¢ÃÂÃÂ Traffic',         sub:'tbl 008ÃÂ¢ÃÂÃÂ010, 069',           layer:7, x:1390, y:278,  w:180, h:50, color:'#ffd23f',
    detail:'TrafficSection.tsx ÃÂ¢ÃÂÃÂ AADT map, ATC dashboard, growth projections. tbl-008 (AADT by link), tbl-009 (vehicle composition), tbl-010 (ATC hourly), tbl-069 (TIS stations).' },
  { id:'sec-ndpiv',    label:'NDPIV Projects',        sub:'tbl 014, 086',               layer:7, x:1390, y:340,  w:180, h:50, color:'#b967ff',
    detail:'NdpivSection.tsx ÃÂ¢ÃÂÃÂ NDP IV project map and table. tbl-014 (NDPIV project list), tbl-086 (funding allocations FY2025/26).' },
  { id:'sec-oprc',     label:'OPRC Lots',             sub:'tbl 013, 085',               layer:7, x:1390, y:402,  w:180, h:50, color:'#00ff88',
    detail:'OprcSection.tsx ÃÂ¢ÃÂÃÂ 6 OPRC lots. tbl-013 (contract details), tbl-085 (performance monitoring).' },
  { id:'sec-overload', label:'Overloading / ESAL',    sub:'tbl 023ÃÂ¢ÃÂÃÂ028',                layer:7, x:1390, y:464,  w:180, h:50, color:'#ef4444',
    detail:'OverloadingSection.tsx ÃÂ¢ÃÂÃÂ 1,020 links scored. tbl-023-028 (axle load distributions, ESAL factors, overloading frequency, risk index). Source: overloading_by_link.' },
  { id:'sec-lcm',      label:'Lifecycle Mgmt',        sub:'tbl 041ÃÂ¢ÃÂÃÂ046',                layer:7, x:1390, y:526,  w:180, h:50, color:'#34d399',
    detail:'LifecycleSection.tsx ÃÂ¢ÃÂÃÂ IRI deterioration curves, intervention history, LCCA. tbl-041-046. Source: lifecycle_links + lifecycle_interventions.' },
  { id:'sec-budget',   label:'Budget & Maintenance',  sub:'tbl 020, 021, 074',          layer:7, x:1390, y:588,  w:180, h:50, color:'#ff2d78',
    detail:'BudgetSection.tsx ÃÂ¢ÃÂÃÂ maintenance expenditure, MTEF planning. tbl-020 (maintenance budget by FY), tbl-021 (development budget), tbl-074 (M&R needs). Source: budget_fy_summary + budget_alignment.' },
  { id:'sec-projects', label:'Projects & Works',      sub:'tbl 015ÃÂ¢ÃÂÃÂ019',                layer:7, x:1390, y:650,  w:180, h:50, color:'#f472b6',
    detail:'ProjectTracker ÃÂ¢ÃÂÃÂ execution tracking (Gantt/Kanban), physical vs financial progress. tbl-015-019. Source: project_tracker + projects.' },
  { id:'sec-pim',      label:'Public Investment',     sub:'tbl 080ÃÂ¢ÃÂÃÂ084',                layer:7, x:1390, y:712,  w:180, h:50, color:'#c084fc',
    detail:'PublicInvestmentSection.tsx ÃÂ¢ÃÂÃÂ PIM funding, PPP projects, donor vs GoU split. tbl-080-084. Source: budget_fy_summary + ppp_projects.' },
  { id:'sec-global',   label:'Global Case Studies',   sub:'tbl 090ÃÂ¢ÃÂÃÂ100',                layer:7, x:1390, y:774,  w:180, h:50, color:'#7dd3fc',
    detail:'GlobalCaseStudiesSection.tsx ÃÂ¢ÃÂÃÂ 16-country comparative RMS/BMS benchmarking. tbl-090-100. Source: global_case_studies.' },
];

// Bounding box of all node geometry ÃÂ¢ÃÂÃÂ used to "fit to content" the canvas
...
const EDGES: Edge[] = [
  ...
  // L4 ÃÂ¢ÃÂÃÂ L5 ÃÂ¢ÃÂÃÂ Unified DB feeds the algorithm / query / decision layer
  { from:'out-db',       to:'alg-engine',     label:'reads' },
  { from:'out-db',       to:'qry-views',      label:'queries' },
  { from:'out-db',       to:'dtree',          label:'rules' },
  // L4 ÃÂ¢ÃÂÃÂ L6 ÃÂ¢ÃÂÃÂ Tabular Summaries Hub sources EVERYTHING from the Unified DB
  { from:'out-db',       to:'tbl-hub',        label:'sources all' },
  { from:'out-json',     to:'tbl-hub',        label:'client cache' },
  // L5 ÃÂ¢ÃÂÃÂ L6 ÃÂ¢ÃÂÃÂ computed logic feeds the hub
  ...
  // L6 hub ÃÂ¢ÃÂÃÂ every platform section (RMS, Road Reserve, + all others)
...
// ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Drawing-zone reference (e.g. [A3]) ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
...
// ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Orthogonal (right-angle) edge routing ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
...
// ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Component ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
...
export default function MindMapSection() {
  ...
  // Fit the diagram exactly to the visible canvas ÃÂ¢ÃÂÃÂ eliminates wasted blank
  ...
  // panel ÃÂ¢ÃÂÃÂ its measured size can be 0 (or stale) on the very first layout
    ...
    <div style={{
      ...
      <div style={{
        ...
        <span style={{ fontSize: 10, fontWeight: 800, color: '#00bcd4', letterSpacing: '0.12em', fontFamily: MONO }}>
          ÃÂ¢ÃÂÃÂ¦ DATA PIPELINE ÃÂ¢ÃÂÃÂ SCHEMATIC
        </span>
        <div style={{ width: 1, height: 18, background: 'rgba(0,188,212,0.18)' }} />
        {/* Layer toggles ÃÂ¢ÃÂÃÂ drawn as blueprint switches */}
        {LAYERS.map(l => {
          ...
          return (
            <button key={l} onClick={() => toggleLayer(l)} style={{
              ...
              [{on ? 'ÃÂ¢ÃÂÃÂ ' : 'ÃÂ¢ÃÂÃÂ¡'}] {LAYER_LABELS[l]}
            </button>
          );
        })}
        ...
        <span style={{ fontSize: 9, color: 'rgba(125,211,224,0.35)', marginLeft: 4, fontFamily: MONO }}>
          DRAG ÃÂÃÂ· PAN ÃÂ¢ÃÂÃÂ SCROLL ÃÂÃÂ· ZOOM ÃÂ¢ÃÂÃÂ CLICK ÃÂÃÂ· INSPECT
        </span>
      </div>
        ...
        >
          <svg width="100%" height="100%" style={{ display: 'block' }}>
            ...
            <g transform={`translate(${pan.x}, ${pan.y}) scale(${zoom})`}>
              ...
              {/* Edges ÃÂ¢ÃÂÃÂ orthogonal routing */}
              ...
              {/* Nodes ÃÂ¢ÃÂÃÂ engineering drawing boxes */}
          ...
          {/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Engineering drawing title block (bottom-right) ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */}
          <div style={{
                ...
                {(() => {
                      ...
                      <>
                        ...
                        {a.params.map((x, i) => (
                          <div key={i} style={{ display: 'flex', gap: 6, fontSize: 9.5, color: 'rgba(226,232,240,0.85)', lineHeight: 1.6 }}>
                            <span style={{ color: selected.color, fontWeight: 900 }}>ÃÂ¢ÃÂÃÂ¸</span><span>{x}</span>
                          </div>
                        ))}
                      </>
                    );
                  ...
                  return (
                    <div style={{ fontSize: 9.5, color: 'rgba(226,232,240,0.8)', lineHeight: 1.65 }}>
                      <span style={{ color: selected.color, fontWeight: 900 }}>ÃÂ¢ÃÂÃÂ¸ </span>{selected.sub}
                      <br /><span style={{ color: selected.color, fontWeight: 900 }}>ÃÂ¢ÃÂÃÂ¸ </span>{selected.detail}
                    </div>
                  );
                })()}
              </div>
...
// Parameters & algorithms per node ÃÂ¢ÃÂÃÂ shown in the inspector instead of wireframes.
const ALGO_DETAILS: Record<string, { algo: string; params: string[] }> = {
  'ag-ml': {
    ...
    params: ['Inputs: IRI, rutting, AADT, ESALs, pavement age, rainfall zone',
             'DNN: 4 hidden layers ÃÂÃÂ· ReLU ÃÂÃÂ· dropout 0.2 ÃÂÃÂ· Adam 1e-3',
             'GNN: link-adjacency message passing, 2 hops',
             'Target: next-cycle VCI / IRI per link',
             'Validation: 80/20 split ÃÂÃÂ· early stopping on RMSE'] },
  'alg-engine': {
    algo: 'HDM-4 deterioration ÃÂÃÂ· ESAL accumulation ÃÂÃÂ· life-cycle cost analysis (LCCA)',
    params: ['HDM-4 RDWE roughness progression: ÃÂÃÂIRI = f(age, ESAL, MMP, SNC)',
             'ESAL: ÃÂÃÂ£ (axle load / 8.16 t)^4.5 by vehicle class',
             'LCCA: NPV @ 12% discount, 20-year analysis period',
             'Calibrated with romdas_calibration.json coefficients'] },
  'dtree': {
    algo: 'Rule-based decision trees ÃÂ¢ÃÂÃÂ maintenance recommendations',
    params: ['Thresholds: VCI bands (ÃÂ¢ÃÂÃÂ¥85/75/65/55) ÃÂÃÂ· IRI > 4.5 ÃÂ¢ÃÂÃÂ periodic',
             'Treatment ladder: routine ÃÂ¢ÃÂÃÂ resealing ÃÂ¢ÃÂÃÂ overlay ÃÂ¢ÃÂÃÂ reconstruction',
             'Bridge rules: element rating ÃÂ¢ÃÂÃÂ¤ 2 ÃÂ¢ÃÂÃÂ inspection work order',
             'Budget guardrail: ranked by stress score within envelope'] },
  'proc-analytics': {
    algo: 'Aggregation engine ÃÂ¢ÃÂÃÂ regional, budget and ESAL summaries',
  ...
  'ag-qc': {
    ...
    params: ['JSON-schema checks on every exported file',
             'Range checks: VCI 0ÃÂ¢ÃÂÃÂ100 ÃÂÃÂ· IRI 1ÃÂ¢ÃÂÃÂ20 ÃÂÃÂ· AADT > 0',
  ...
  'proc-export': {
    ...
    params: ['Sources: NDPIV xlsx ÃÂÃÂ· network2026 shapefile ÃÂÃÂ· BMS CSV ÃÂÃÂ· ATC workbook',
             'refresh_2026.py ÃÂÃÂ· build_fwd_inventory.py ÃÂÃÂ· export_bundle.py',
...
// ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Section-screen templates (sidebar + tabs + content) ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
...
// ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Pipeline-node templates (no sidebar ÃÂ¢ÃÂÃÂ a process / IO sketch) ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
...
const WIREFRAMES: Record<string, Wireframe> = {
  ...
  // L3 ÃÂ¢ÃÂÃÂ Agents
  'ag-ml':    flow3('DATA', 'DNN / GNN', 'IRIÃÂÃÂ·VCI'),
  ...
  // L5 ÃÂ¢ÃÂÃÂ Algorithms & Logic
  ...
  // L6 ÃÂ¢ÃÂÃÂ Data Hub
  'tbl-hub': secBigTable(['Tabular Summaries', 'Charts', 'References']),
  // L7 ÃÂ¢ÃÂÃÂ Platform sections
...
function drawWfEl(el: WfEl, i: number): React.ReactNode {
  ...
  switch (t) {
    ...
    case 'tree': { // decision tree: root ÃÂ¢ÃÂÃÂ 2 ÃÂ¢ÃÂÃÂ 4
          ...
          return (
            <g key={tab}>
              ...
              <text x={tx + tw / 2} y={12} textAnchor="middle" fontSize="5.5" fontFamily={WF_MONO} fill={k === 0 ? '#eaffff' : WF_L}>
                {tab.length > 9 ? tab.slice(0, 8) + 'ÃÂ¢ÃÂÃÂ¦' : tab}
              </text>
            </g>
          );
        })}
