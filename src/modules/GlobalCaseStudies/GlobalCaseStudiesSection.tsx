/**
 * GlobalCaseStudiesSection â Global Road Management System Case Studies
...
// ââ Region colour map âââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
...
// ââ Case studies data â 150+ countries âââââââââââââââââââââââââââââââââââââââ

const CASE_STUDIES: CaseStudy[] = [
  // ââ Detailed entries (original 15) ââââââââââââââââââââââââââââââââââââââââââ
  {
    id: 1, agency: 'TANROADS', country: 'Tanzania', flag: 'ð¹ð¿',
  ...
  {
    id: 2, agency: 'KeNHA', country: 'Kenya', flag: 'ð°ðª',
    ...
    metrics: '74% paved serviceability â¥ 3.5 PSI; bridge safety compliance 89%',
  },
  {
    id: 3, agency: 'RTDA', country: 'Rwanda', flag: 'ð·ð¼',
    networkKm: 4700, system: 'RAMS + OPRC', pavedPct: 34, rmsYears: 12,
    budgetPerKmUsd: 28000, region: 'Africa', lat: -1.94, lng: 29.87,
    keyFeatures: [
      'Paved network grew 18% â 34% in 10 years',
    ...
    metrics: 'Avg IRI reduced 4.8 â 3.1 m/km (2015-2024); road sector GDP contribution +2.4%',
  },
  {
    id: 4, agency: 'SANRAL', country: 'South Africa', flag: 'ð¿ð¦',
  ...
  {
    id: 5, agency: 'Highways England', country: 'United Kingdom', flag: 'ð¬ð§',
    ...
    metrics: '97.4% meeting serviceability standard; Â£6 return per Â£1 preventive maintenance',
  },
  {
    id: 6, agency: 'Austroads / DPTI', country: 'Australia', flag: 'ð¦ðº',
  ...
  {
    id: 7, agency: 'NZTA Waka Kotahi', country: 'New Zealand', flag: 'ð³ð¿',
  ...
  {
    id: 8, agency: 'FHWA / State DOTs', country: 'USA', flag: 'ðºð¸',
  ...
  {
    id: 9, agency: 'NHAI / NRRDA', country: 'India', flag: 'ð®ð³',
  ...
  {
    id: 10, agency: 'Trafikverket', country: 'Sweden', flag: 'ð¸ðª',
  ...
  {
    id: 11, agency: 'Rijkswaterstaat', country: 'Netherlands', flag: 'ð³ð±',
    ...
    lessonsDNR: "RWS's monthly AHI providing a single condition number per link is an excellent model for DNR â simplifying reporting to MoWT and Parliament while retaining full technical detail.",
    ...
    metrics: '99.2% availability; predictive maintenance savings â¬180m/yr',
  },
  {
    id: 12, agency: 'MLIT', country: 'Japan', flag: 'ð¯ðµ',
  ...
  {
    id: 13, agency: 'DNIT', country: 'Brazil', flag: 'ð§ð·',
  ...
  {
    id: 14, agency: 'GHA', country: 'Ghana', flag: 'ð¬ð­',
    ...
    lessonsDNR: "Ghana's GHIAS phased rollout starting with highest-traffic paved network reduced initial costs while building institutional capacity â matches DNR's current stage.",
  ...
  {
    id: 15, agency: 'ERA', country: 'Ethiopia', flag: 'ðªð¹',
    ...
    lessonsDNR: "Ethiopia's RRAMPS phased approach â first establishing a condition baseline, then building the analysis framework, then linking to budget â matches DNR's current stage exactly.",
  ...
  // ââ Sub-Saharan Africa âââââââââââââââââââââââââââââââââââââââââââââââââââââââ
  { id:16, agency:'FERMA/FMWH', country:'Nigeria', flag:'ð³ð¬', networkKm:35000, system:'NRAMP + HDM-4', pavedPct:49, rmsYears:8, budgetPerKmUsd:11000, region:'Africa', lat:9.08, lng:8.68,
    keyFeatures:['Federal Roads Maintenance Agency managing 35,000 km national network','OPRC pilots on LagosâIbadan and AbujaâKaduna corridors'],
    lessonsDNR:'Nigeria\'s shift from input-based to OPRC on high-traffic corridors achieved 22% cost reduction â directly applicable to DNR\'s Class A corridors.',
  ...
  { id:17, agency:'ANE', country:'Mozambique', flag:'ð²ð¿', networkKm:30200, system:'RAMS + HDM-4', pavedPct:27, rmsYears:12, budgetPerKmUsd:10500, region:'Africa', lat:-18.67, lng:35.53,
    keyFeatures:['HDM-4 calibrated for tropical coastal conditions','Annual ROMDAS on paved national roads (N1âN14)'],
  ...
  { id:18, agency:'DNA/INEA', country:'Angola', flag:'ð¦ð´', networkKm:26000, system:'PMS + Bentley', pavedPct:24, rmsYears:7, budgetPerKmUsd:18000, region:'Africa', lat:-11.20, lng:17.87,
    keyFeatures:['Post-conflict reconstruction of 26,000 km national network','Bentley OpenRoads Asset management system'],
    lessonsDNR:'Angola\'s rapid network rebuild after conflict shows the importance of establishing a GIS baseline before procurement â DNR\'s GeoJSON provides exactly that foundation.',
  ...
  { id:19, agency:'ZINARA/DDF', country:'Zimbabwe', flag:'ð¿ð¼', networkKm:18338, system:'RAMS', pavedPct:47, rmsYears:10, budgetPerKmUsd:8500, region:'Africa', lat:-19.02, lng:29.15,
  ...
  { id:20, agency:'RDA Zambia', country:'Zambia', flag:'ð¿ð²', networkKm:67000, system:'ROSY + HDM-4', pavedPct:25, rmsYears:13, budgetPerKmUsd:9200, region:'Africa', lat:-13.13, lng:27.85,
    keyFeatures:['Roads Development Agency managing 67,000 km network','Community Road Maintenance Scheme (CRMS) for rural roads'],
    lessonsDNR:'Zambia\'s CRMS â paying local communities to maintain rural Class C gravel roads â is highly adaptable to Uganda\'s Northern and Eastern low-volume road network.',
  ...
  { id:21, agency:'MoTPW Malawi', country:'Malawi', flag:'ð²ð¼', networkKm:14600, system:'NRMP + HDM-4', pavedPct:28, rmsYears:9, budgetPerKmUsd:7800, region:'Africa', lat:-13.25, lng:34.30,
    keyFeatures:['AfDB-funded National Roads Management Programme','Road Fund Administration Board managing maintenance budget'],
    lessonsDNR:'Malawi\'s Road Fund Administration provides a governance model for independent maintenance budget management â relevant to DNR\'s MTEF planning.',
  ...
  { id:22, agency:'RAMSB Botswana', country:'Botswana', flag:'ð§ð¼', networkKm:25798, system:'RAMSB', pavedPct:33, rmsYears:15, budgetPerKmUsd:21000, region:'Africa', lat:-22.33, lng:24.68,
    keyFeatures:['RAMSB â Roads Asset Management System Botswana â custom-built','Climate-adjusted deterioration models for semi-arid conditions'],
  ...
  { id:23, agency:'Roads Authority Namibia', country:'Namibia', flag:'ð³ð¦', networkKm:48875, system:'HAMS', pavedPct:14, rmsYears:14, budgetPerKmUsd:12000, region:'Africa', lat:-22.96, lng:18.49,
    keyFeatures:['HAMS Highway Asset Management System','Extensive gravel network with annual blading programme (40,000+ km)'],
    lessonsDNR:'Namibia\'s annual motor grader blading programme on 40,000+ km of gravel roads â with performance targets per km â is the most applicable model for DNR\'s Class C unsealed roads.',
  ...
  { id:24, agency:'MoPublicWorks Lesotho', country:'Lesotho', flag:'ð±ð¸', networkKm:5940, system:'PMS', pavedPct:20, rmsYears:6, budgetPerKmUsd:14000, region:'Africa', lat:-29.61, lng:28.23,
  ...
  { id:25, agency:'Roads Dept Eswatini', country:'Eswatini', flag:'ð¸ð¿', networkKm:3594, system:'RAMPAS', pavedPct:41, rmsYears:7, budgetPerKmUsd:16500, region:'Africa', lat:-26.52, lng:31.47,
    keyFeatures:['Small network, high-quality data management','OPRC pilot on MR1 and MR3 main roads'],
    lessonsDNR:'Eswatini\'s small-network OPRC shows that performance contracts are viable even on shorter corridors â applicable to DNR\'s Urban Bypass OPRC lots.',
    dataApproach:'Annual ROMDAS + visual; shared SADC database', funding:'GoE + donor grants', metrics:'41% paved; 71% good/fair' },

  { id:26, agency:'MATP Madagascar', country:'Madagascar', flag:'ð²ð¬', networkKm:31640, system:'GRIS + HDM-4', pavedPct:12, rmsYears:8, budgetPerKmUsd:6500, region:'Africa', lat:-18.77, lng:46.87,
  ...
  { id:27, agency:'DVDA/OEBK', country:'DR Congo', flag:'ð¨ð©', networkKm:58000, system:'Basic PMS', pavedPct:9, rmsYears:4, budgetPerKmUsd:5500, region:'Africa', lat:-4.04, lng:21.76,
    keyFeatures:['Rebuilding national network post-conflict','World Bank DRC Roads Sector Development Project'],
    lessonsDNR:'DRC\'s World Bank-funded sector development project used simple visual condition tools with mobile apps â a scalable model for DNR\'s Class C rural coverage.',
  ...
  { id:28, agency:'DGGT Rep. Congo', country:'Rep. of Congo', flag:'ð¨ð¬', networkKm:17000, system:'PMS', pavedPct:17, rmsYears:5, budgetPerKmUsd:9000, region:'Africa', lat:-0.23, lng:15.83,
    ...
    dataApproach:'Visual surveys; periodic laser profilometer on paved', funding:'GoC oil revenues + AfDB', metrics:'17% paved; N1 BrazzavilleâPointe-Noire 78% good' },

  { id:29, agency:'MINTP Cameroon', country:'Cameroon', flag:'ð¨ð²', networkKm:77000, system:'SIGMA', pavedPct:15, rmsYears:10, budgetPerKmUsd:8200, region:'Africa', lat:3.85, lng:11.50,
    keyFeatures:['SIGMA road database system (French-language)','Performance-based contracts on YaoundÃ©âDouala corridor'],
    lessonsDNR:'Cameroon\'s OPRC on the YaoundÃ©âDouala economic corridor demonstrates how to prioritise the highest freight-value route â matching DNR\'s KampalaâGulu A109 priority.',
  ...
  { id:30, agency:'FHA Nigeria (state)', country:'CÃ´te d\'Ivoire', flag:'ð¨ð®', networkKm:12000, system:'SITP + HDM-4', pavedPct:58, rmsYears:11, budgetPerKmUsd:16000, region:'Africa', lat:7.54, lng:-5.55,
    keyFeatures:['French-speaking West Africa\'s most developed road network','Public-private toll concession on A1 and A3'],
    lessonsDNR:'CÃ´te d\'Ivoire\'s PPP toll concession model for Class A expressways is applicable to Uganda\'s Kampala Northern Bypass.',
  ...
  { id:31, agency:'AGEROUTE Senegal', country:'Senegal', flag:'ð¸ð³', networkKm:16664, system:'AGEROUTE PMS', pavedPct:60, rmsYears:12, budgetPerKmUsd:15000, region:'Africa', lat:14.50, lng:-14.45,
    keyFeatures:['AGEROUTE model: separate agency for construction and maintenance','OPRC on 3,500 km of national roads'],
    lessonsDNR:'Senegal\'s AGEROUTE institutional model â separating road administration from works execution â improves accountability and is worth evaluating for DNR\'s structure.',
  ...
  { id:32, agency:'DNGC Mali', country:'Mali', flag:'ð²ð±', networkKm:22000, system:'SYGER + HDM-4', pavedPct:30, rmsYears:7, budgetPerKmUsd:7000, region:'Africa', lat:17.57, lng:-3.99,
    keyFeatures:['SYGER road management system (French-language)','HDM-4 linked to MCA Compact investment planning'],
    lessonsDNR:'Mali\'s MCA Compact used HDM-4 to select 196 km of feeder roads for investment based on economic return â a direct model for DNR\'s Class C selection framework.',
    dataApproach:'Visual + GPS; SYGER database', funding:'World Bank, MCA, AFD, GoM', metrics:'30% paved; 58% in maintainable condition' },

  { id:33, agency:'FERA Burkina Faso', country:'Burkina Faso', flag:'ð§ð«', networkKm:15400, system:'PMS + HDM-4', pavedPct:25, rmsYears:8, budgetPerKmUsd:7200, region:'Africa', lat:12.36, lng:-1.53,
    keyFeatures:['FERA road maintenance fund with dedicated fuel levy','Performance contracts on RN1 and RN2'],
    lessonsDNR:'Burkina Faso\'s dedicated fuel levy for road maintenance â ring-fenced and audited â provides a model for Uganda\'s Road Fund reform.',
  ...
  { id:34, agency:'DGTP Niger', country:'Niger', flag:'ð³ðª', networkKm:18901, system:'PMS', pavedPct:27, rmsYears:6, budgetPerKmUsd:6500, region:'Africa', lat:17.61, lng:8.08,
  ...
  { id:35, agency:'DGTTM Chad', country:'Chad', flag:'ð¹ð©', networkKm:40000, system:'Basic PMS', pavedPct:8, rmsYears:4, budgetPerKmUsd:5000, region:'Africa', lat:15.45, lng:18.73,
    keyFeatures:['Rebuilding network after decades of conflict','EU-funded road corridor development'],
    lessonsDNR:'Chad\'s emergency road condition baseline survey methodology â rapid visual with GPS â is instructive for DNR\'s coverage of unmapped Class C roads in Karamoja.',
  ...
  { id:36, agency:'SUDAAK Sudan', country:'Sudan', flag:'ð¸ð©', networkKm:24000, system:'RAMS + HDM-4', pavedPct:65, rmsYears:9, budgetPerKmUsd:8000, region:'Africa', lat:12.86, lng:30.22,
    keyFeatures:['Desert highway management for the KhartoumâHalfa corridor','OPRC pilot on 800 km Section 1'],
    lessonsDNR:'Sudan\'s desert highway deterioration models â focused on thermal cracking and wind abrasion â are relevant for Uganda\'s dry Northern region roads.',
  ...
  { id:37, agency:'UNRA / DNR', country:'Uganda', flag:'ðºð¬', networkKm:21302, system:'DNR RMS Engine', pavedPct:30, rmsYears:6, budgetPerKmUsd:12500, region:'Africa', lat:1.37, lng:32.29,
    keyFeatures:['Official network: 21,302 km (NDPIV FY25-26)','ML-powered IRI prediction (PyTorch, RÂ²=0.93)','1,017 links in GeoJSON; 6 OPRC lots','10 ATC + 298 TIS traffic monitoring stations'],
    lessonsDNR:'This is the DNR platform itself â the benchmarks shown here represent Uganda\'s current asset management maturity and the targets set by this system.',
    dataApproach:'ROMDAS annual surveys; ATC + TIS traffic counts; bridge inspections; satellite imagery', funding:'GoU Road Fund + World Bank + AfDB + JICA', metrics:'Official: 21,302 km | Mapped: 21,160 km (1,017 links) | Paved: 6,405 km (30.1%)' },

  { id:38, agency:'OBUHA Burundi', country:'Burundi', flag:'ð§ð®', networkKm:12322, system:'PMS', pavedPct:22, rmsYears:5, budgetPerKmUsd:7000, region:'Africa', lat:-3.37, lng:29.92,
  ...
  { id:39, agency:'MOPW Somalia', country:'Somalia', flag:'ð¸ð´', networkKm:6000, system:'Basic', pavedPct:11, rmsYears:3, budgetPerKmUsd:4500, region:'Africa', lat:5.15, lng:46.20,
    keyFeatures:['Post-conflict road rehabilitation','HargeisaâBerbera corridor reconstruction'],
    lessonsDNR:'Somalia\'s post-conflict network baseline approach â mapping what exists before setting targets â is a reminder that establishing accurate GIS data is the first requirement for any RMS.',
  ...
  { id:40, agency:'NRDA Eritrea', country:'Eritrea', flag:'ðªð·', networkKm:4010, system:'PMS', pavedPct:80, rmsYears:8, budgetPerKmUsd:9500, region:'Africa', lat:15.18, lng:39.78,
  ...
  { id:41, agency:'DNED Djibouti', country:'Djibouti', flag:'ð©ð¯', networkKm:3065, system:'Basic PMS', pavedPct:60, rmsYears:4, budgetPerKmUsd:18000, region:'Africa', lat:11.83, lng:42.59,
    keyFeatures:['Port logistics corridor road management','Chinese-funded DjiboutiâAddis railway parallel road'],
  ...
  { id:42, agency:'MoRB South Sudan', country:'South Sudan', flag:'ð¸ð¸', networkKm:90000, system:'Basic', pavedPct:1, rmsYears:2, budgetPerKmUsd:3500, region:'Africa', lat:6.88, lng:31.31,
  ...
  { id:43, agency:'SLRA Sierra Leone', country:'Sierra Leone', flag:'ð¸ð±', networkKm:11700, system:'PMS', pavedPct:15, rmsYears:6, budgetPerKmUsd:7500, region:'Africa', lat:8.46, lng:-11.78,
    keyFeatures:['World Bank-funded road rehabilitation','Community-based road maintenance programme'],
    lessonsDNR:'Sierra Leone\'s community-based maintenance â paying local groups to maintain short gravel sections â is a low-cost model for DNR\'s unmaintained Class C links.',
  ...
  { id:44, agency:'MPWT Liberia', country:'Liberia', flag:'ð±ð·', networkKm:10600, system:'PMS', pavedPct:13, rmsYears:5, budgetPerKmUsd:6800, region:'Africa', lat:6.43, lng:-9.43,
  ...
  { id:45, agency:'DNTP Guinea', country:'Guinea', flag:'ð¬ð³', networkKm:44348, system:'PMS', pavedPct:21, rmsYears:6, budgetPerKmUsd:8000, region:'Africa', lat:10.99, lng:-10.96,
    keyFeatures:['Mining corridor road management','ConakryâMamou expressway OPRC'],
    lessonsDNR:'Guinea\'s mining-corridor OPRC links infrastructure investment to commodity export economics â a model for DNR considering Albertine oil corridor roads.',
  ...
  { id:46, agency:'INASA Guinea-Bissau', country:'Guinea-Bissau', flag:'ð¬ð¼', networkKm:4400, system:'Basic PMS', pavedPct:24, rmsYears:4, budgetPerKmUsd:6000, region:'Africa', lat:11.80, lng:-15.18,
  ...
  { id:47, agency:'MoPWG Gambia', country:'Gambia', flag:'ð¬ð²', networkKm:3742, system:'PMS', pavedPct:28, rmsYears:5, budgetPerKmUsd:11000, region:'Africa', lat:13.44, lng:-15.31,
  ...
  { id:48, agency:'MTPT Mauritania', country:'Mauritania', flag:'ð²ð·', networkKm:12348, system:'PMS', pavedPct:30, rmsYears:7, budgetPerKmUsd:9000, region:'Africa', lat:20.25, lng:-10.94,
    keyFeatures:['Sahara desert road management','Trans-Mauritanian Highway (RN1) performance contract'],
    lessonsDNR:'Mauritania\'s desert highway performance contract â with IRI targets adjusted for windblown sand â shows IRI standards can be adapted to extreme environments.',
  ...
  { id:49, agency:'MTIE Cape Verde', country:'Cape Verde', flag:'ð¨ð»', networkKm:1350, system:'PMS', pavedPct:70, rmsYears:10, budgetPerKmUsd:22000, region:'Africa', lat:16.00, lng:-24.01,
  ...
  { id:50, agency:'DGTP Comoros', country:'Comoros', flag:'ð°ð²', networkKm:880, system:'Basic PMS', pavedPct:52, rmsYears:3, budgetPerKmUsd:14000, region:'Africa', lat:-11.70, lng:43.37,
  ...
  { id:51, agency:'MTAC Seychelles', country:'Seychelles', flag:'ð¸ð¨', networkKm:526, system:'PMS', pavedPct:90, rmsYears:12, budgetPerKmUsd:45000, region:'Africa', lat:-4.68, lng:55.49,
    keyFeatures:['High-income island road management','Tourism-driven maintenance standards'],
    lessonsDNR:'Seychelles\' tourism-linked road quality standards â where road condition directly affects GDP â mirrors the economic case DNR should make for Uganda\'s NDP IV targets.',
  ...
  { id:52, agency:'RDA Mauritius', country:'Mauritius', flag:'ð²ðº', networkKm:2060, system:'RAMPAS + HDM-4', pavedPct:98, rmsYears:18, budgetPerKmUsd:55000, region:'Africa', lat:-20.35, lng:57.55,
  ...
  { id:53, agency:'DGTP Togo', country:'Togo', flag:'ð¹ð¬', networkKm:11734, system:'PMS + HDM-4', pavedPct:30, rmsYears:8, budgetPerKmUsd:8500, region:'Africa', lat:8.62, lng:0.82,
    keyFeatures:['WAEMU corridor management for transit traffic','LomÃ© Port approach roads maintenance contract'],
    lessonsDNR:'Togo\'s port approach road maintenance contract links road performance to container throughput KPIs â a model for DNR\'s Jinja bridge approach road management.',
  ...
  { id:54, agency:'AGETUR Benin', country:'Benin', flag:'ð§ð¯', networkKm:9800, system:'PMS', pavedPct:22, rmsYears:7, budgetPerKmUsd:8000, region:'Africa', lat:9.31, lng:2.32,
  ...
  { id:55, agency:'ANGONAV Gabon', country:'Gabon', flag:'ð¬ð¦', networkKm:9170, system:'PMS', pavedPct:27, rmsYears:6, budgetPerKmUsd:20000, region:'Africa', lat:-0.80, lng:11.61,
    keyFeatures:['Oil-funded road rehabilitation','Libreville urban expressway PPP'],
    lessonsDNR:'Gabon\'s oil-revenue funded road maintenance demonstrates how resource rents can finance sustainable infrastructure â relevant for Uganda\'s Albertine oil development corridor.',
  ...
  { id:56, agency:'MOPWT Equatorial Guinea', country:'Equatorial Guinea', flag:'ð¬ð¶', networkKm:2880, system:'PMS', pavedPct:34, rmsYears:5, budgetPerKmUsd:25000, region:'Africa', lat:1.65, lng:10.27,
    keyFeatures:['Oil-funded road investment in small network','MalaboâBata highway as showcase project'],
    lessonsDNR:'Equatorial Guinea\'s showcase highway investment highlights the difference between political prestige projects and systematic maintenance funding â DNR must advocate for maintenance budgets.',
  ...
  { id:57, agency:'MOPH CAR', country:'Central African Republic', flag:'ð¨ð«', networkKm:24307, system:'Basic', pavedPct:5, rmsYears:2, budgetPerKmUsd:3000, region:'Africa', lat:6.61, lng:20.94,
    keyFeatures:['Post-conflict minimal road maintenance','UN-supported basic road rehabilitation'],
    lessonsDNR:'CAR\'s experience confirms that political stability is a prerequisite for sustainable road asset management â Uganda\'s relative stability is itself a competitive advantage for investment.',
  ...
  // ââ North Africa âââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
  { id:58, agency:'GARBLT Egypt', country:'Egypt', flag:'ðªð¬', networkKm:65000, system:'RMS-Egypt + HDM-4', pavedPct:95, rmsYears:18, budgetPerKmUsd:20000, region:'Africa', lat:26.82, lng:30.80,
    ...
    lessonsDNR:'Egypt\'s automated condition monitoring on the Cairo Ring Road â using mounted sensors on fleet vehicles â is a cost-effective alternative to ROMDAS for high-traffic Class A roads.',
  ...
  { id:59, agency:'GDAT Libya', country:'Libya', flag:'ð±ð¾', networkKm:37000, system:'Basic PMS', pavedPct:77, rmsYears:5, budgetPerKmUsd:15000, region:'Africa', lat:26.34, lng:17.23,
  ...
  { id:60, agency:'DGGC Tunisia', country:'Tunisia', flag:'ð¹ð³', networkKm:19232, system:'PMS + HDM-4', pavedPct:73, rmsYears:20, budgetPerKmUsd:18000, region:'Africa', lat:33.89, lng:9.54,
    ...
    lessonsDNR:'Tunisia\'s 20-year HDM-4 data series demonstrates how long-run calibrated analysis improves decision-making â DNR should invest in longitudinal data continuity.',
  ...
  { id:61, agency:'CNER Algeria', country:'Algeria', flag:'ð©ð¿', networkKm:113655, system:'SIGAL + HDM-4', pavedPct:73, rmsYears:15, budgetPerKmUsd:22000, region:'Africa', lat:28.03, lng:1.66,
    keyFeatures:['EastâWest Highway 1,200 km expressway management','SIGAL national road management information system','Desert road management for Sahara sections'],
    lessonsDNR:'Algeria\'s SIGAL system for long expressway sections uses segment-based condition reporting â directly applicable to DNR\'s link-based GeoJSON management approach.',
  ...
  { id:62, agency:'DRCR Morocco', country:'Morocco', flag:'ð²ð¦', networkKm:57227, system:'SIRAM + HDM-4', pavedPct:75, rmsYears:22, budgetPerKmUsd:25000, region:'Africa', lat:31.79, lng:-7.09,
    keyFeatures:['Most advanced road management in Africa','SIRAM â SystÃ¨me d\'Information RoutiÃ¨re et d\'Aide Ã  la Maintenance','Autoroutes du Maroc: 1,800 km fully operated concession network'],
    lessonsDNR:'Morocco\'s SIRAM is the most developed French-language road management system in Africa â it provides the strongest African role model for DNR\'s ambition to become the East African benchmark.',
  ...
  // ââ Middle East ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
  { id:63, agency:'MOT Saudi Arabia', country:'Saudi Arabia', flag:'ð¸ð¦', networkKm:65000, system:'HIMS', pavedPct:96, rmsYears:22, budgetPerKmUsd:42000, region:'Middle East', lat:23.89, lng:45.08,
    ...
    lessonsDNR:'Saudi Arabia\'s AI crack detection deployed at national scale is the most advanced example of technology leapfrogging for pavement inspection â worth adopting for DNR\'s Class A network.',
  ...
  { id:64, agency:'Bayanat / RTA UAE', country:'UAE', flag:'ð¦ðª', networkKm:10000, system:'Advanced AMS', pavedPct:99, rmsYears:20, budgetPerKmUsd:120000, region:'Middle East', lat:23.42, lng:53.85,
    ...
    lessonsDNR:'UAE\'s digital twin of road assets is the global frontier of asset management â DNR\'s GeoJSON + ML model is a scaled-down version of the same concept.',
  ...
  { id:65, agency:'MoPWH Jordan', country:'Jordan', flag:'ð¯ð´', networkKm:7500, system:'RAMS + HDM-4', pavedPct:85, rmsYears:16, budgetPerKmUsd:22000, region:'Middle East', lat:30.59, lng:36.24,
    keyFeatures:['World Bank-funded RAMS','Desert to humid gradient road management','Dead Sea Highway performance contract'],
    lessonsDNR:'Jordan\'s Dead Sea Highway OPRC â linking maintenance standards to tourism KPIs â demonstrates how road condition can be tied to non-transport economic outcomes.',
  ...
  { id:66, agency:'SRB Iraq', country:'Iraq', flag:'ð®ð¶', networkKm:59623, system:'Basic PMS', pavedPct:60, rmsYears:6, budgetPerKmUsd:14000, region:'Middle East', lat:33.22, lng:43.68,
  ...
  { id:67, agency:'MOT Iran', country:'Iran', flag:'ð®ð·', networkKm:199000, system:'IRMS', pavedPct:72, rmsYears:18, budgetPerKmUsd:15000, region:'Middle East', lat:32.43, lng:53.69,
    keyFeatures:['IRMS â Iran Road Management System','Extensive rural road network covering 98% of villages'],
    lessonsDNR:'Iran\'s 98% village connectivity standard â paved or compacted gravel access road to every settlement â sets an aspirational standard for DNR\'s Class C rural access targets.',
  ...
  { id:68, agency:'MOPWT Yemen', country:'Yemen', flag:'ð¾ðª', networkKm:71300, system:'Basic', pavedPct:32, rmsYears:3, budgetPerKmUsd:2500, region:'Middle East', lat:15.55, lng:48.52,
    keyFeatures:['Conflict-affected road network management','UNDP emergency road restoration'],
    lessonsDNR:'Yemen\'s conflict experience demonstrates that road data â even basic GPS-based records â must be backed up off-site, as conflict can destroy institutional databases.',
  ...
  { id:69, agency:'DGRT Oman', country:'Oman', flag:'ð´ð²', networkKm:12000, system:'RAMS + AMS', pavedPct:94, rmsYears:16, budgetPerKmUsd:38000, region:'Middle East', lat:21.51, lng:55.92,
  ...
  { id:70, agency:'MPW Kuwait', country:'Kuwait', flag:'ð°ð¼', networkKm:7800, system:'AMS', pavedPct:99, rmsYears:14, budgetPerKmUsd:85000, region:'Middle East', lat:29.31, lng:47.48,
    keyFeatures:['Desert pavement management for extreme heat','Automated tunnel monitoring system'],
    lessonsDNR:'Kuwait\'s extreme heat pavement management â using high-temperature bitumen specifications â is useful context for DNR\'s climate specification development.',
  ...
  { id:71, agency:'ASHGHAL Qatar', country:'Qatar', flag:'ð¶ð¦', networkKm:9800, system:'QRMS', pavedPct:99, rmsYears:12, budgetPerKmUsd:95000, region:'Middle East', lat:25.35, lng:51.18,
    keyFeatures:['FIFA 2022 World Cup road investment legacy','QRMS â Qatar Roads Management System','Fully BIM-integrated road asset management'],
    lessonsDNR:'Qatar\'s BIM-integrated road assets â where every pipe, cable and structure is modelled â represents the long-term vision for DNR\'s asset registry evolution beyond GeoJSON.',
  ...
  { id:72, agency:'Bapco / MPW Bahrain', country:'Bahrain', flag:'ð§ð­', networkKm:4122, system:'AMS', pavedPct:99, rmsYears:10, budgetPerKmUsd:72000, region:'Middle East', lat:26.02, lng:50.55,
    keyFeatures:['Smallest GCC road network â fully paved','King Fahd Causeway management integration with Saudi Arabia'],
    lessonsDNR:'Bahrain\'s causeway management â shared with Saudi Arabia under one maintenance contract â is a model for DNR\'s cross-border bridge maintenance agreements with Kenya and Tanzania.',
    dataApproach:'Annual surveys; automated monitoring; periodic FWD', funding:'Government', metrics:'99% paved; 91% in good condition' },

  // ââ South Asia âââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
  { id:73, agency:'NHA Pakistan', country:'Pakistan', flag:'ðµð°', networkKm:13000, system:'PAK-RAMS', pavedPct:69, rmsYears:15, budgetPerKmUsd:16000, region:'Asia-Pacific', lat:30.37, lng:69.34,
    ...
    lessonsDNR:'Pakistan\'s CPEC corridor management â integrating road condition with cross-border trade monitoring â is applicable to DNR\'s management of the Northern Corridor and Malaba border.',
  ...
  { id:74, agency:'RHD Bangladesh', country:'Bangladesh', flag:'ð§ð©', networkKm:21302, system:'RMMS + HDM-4', pavedPct:44, rmsYears:18, budgetPerKmUsd:14000, region:'Asia-Pacific', lat:23.68, lng:90.36,
    keyFeatures:['RMMS â Roads and Highways Dept Management System','Flood-resilient road design standards','Annual condition surveys on 21,302 km national network'],
  ...
  { id:75, agency:'RVPN Sri Lanka', country:'Sri Lanka', flag:'ð±ð°', networkKm:11997, system:'RIMS + HDM-4', pavedPct:81, rmsYears:14, budgetPerKmUsd:20000, region:'Asia-Pacific', lat:7.87, lng:80.77,
    keyFeatures:['RIMS â Road Information Management System','Post-war northâsouth network reconstruction','Expressway concession performance contracts'],
    lessonsDNR:'Sri Lanka\'s post-conflict northâsouth reconstruction phased by corridor priority is a sequencing model for DNR\'s NDPIV corridor investment programme.',
  ...
  { id:76, agency:'DoR Nepal', country:'Nepal', flag:'ð³ðµ', networkKm:29024, system:'RAMS + HDM-4', pavedPct:58, rmsYears:12, budgetPerKmUsd:18000, region:'Asia-Pacific', lat:28.39, lng:84.12,
  ...
  { id:77, agency:'DOR Bhutan', country:'Bhutan', flag:'ð§ð¹', networkKm:12205, system:'RAMS + AMS', pavedPct:62, rmsYears:10, budgetPerKmUsd:25000, region:'Asia-Pacific', lat:27.51, lng:90.43,
    ...
    lessonsDNR:'Bhutan\'s GPS-tracked road patrol system â where maintenance teams log every pothole and drainage issue in real time â is an affordable mobile-first model for DNR\'s field inspection workflow.',
  ...
  { id:78, agency:'DRPH Myanmar', country:'Myanmar', flag:'ð²ð²', networkKm:34377, system:'RIMS + HDM-4', pavedPct:17, rmsYears:8, budgetPerKmUsd:9000, region:'Asia-Pacific', lat:19.16, lng:96.71,
    ...
    lessonsDNR:'Myanmar\'s GMS (Greater Mekong Sub-region) corridor programme shows how regional economic integration drives road investment â paralleling Uganda\'s EAC/COMESA corridor logic.',
  ...
  { id:79, agency:'MPW Afghanistan', country:'Afghanistan', flag:'ð¦ð«', networkKm:34000, system:'Basic PMS', pavedPct:29, rmsYears:4, budgetPerKmUsd:6000, region:'Asia-Pacific', lat:33.94, lng:67.71,
    keyFeatures:['Post-conflict road reconstruction with USAID/NATO','Ring Road (2,200 km) as national backbone'],
    lessonsDNR:'Afghanistan\'s Ring Road construction â prioritising a national backbone route before secondary network â reflects the corridor-first strategy embedded in DNR\'s Class A priority investment.',
  ...
  // ââ Southeast Asia âââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
  { id:80, agency:'DOH Thailand', country:'Thailand', flag:'ð¹ð­', networkKm:49000, system:'TH-RAMS + HDM-4', pavedPct:99, rmsYears:22, budgetPerKmUsd:28000, region:'Asia-Pacific', lat:15.87, lng:100.99,
    ...
    lessonsDNR:'Thailand\'s tropical monsoon HDM-4 calibration â accounting for wet-season damage cycles â is the closest climate analogue to Uganda\'s bi-modal rainfall pattern.',
  ...
  { id:81, agency:'DRVN Vietnam', country:'Vietnam', flag:'ð»ð³', networkKm:21000, system:'VRMS + HDM-4', pavedPct:55, rmsYears:16, budgetPerKmUsd:18000, region:'Asia-Pacific', lat:14.06, lng:108.28,
    ...
    lessonsDNR:'Vietnam\'s VRMS performance contracts â with condition KPIs and mobile monitoring â is a mid-income country equivalent of the UK HAPMS system applicable to DNR\'s OPRC evolution.',
  ...
  { id:82, agency:'MPWT Cambodia', country:'Cambodia', flag:'ð°ð­', networkKm:11700, system:'ROCKS + HDM-4', pavedPct:29, rmsYears:10, budgetPerKmUsd:11000, region:'Asia-Pacific', lat:12.57, lng:104.99,
    keyFeatures:['ROCKS road data management system','World Bank-funded pavement management on NR1âNR6','Community road maintenance blocks on rural roads'],
    lessonsDNR:'Cambodia\'s community maintenance blocks on rural roads â community groups responsible for short sections â is a low-cost model for DNR\'s Class C maintenance coverage.',
  ...
  { id:83, agency:'DPWH Laos', country:'Laos', flag:'ð±ð¦', networkKm:39568, system:'RMIS + HDM-4', pavedPct:24, rmsYears:8, budgetPerKmUsd:10000, region:'Asia-Pacific', lat:19.86, lng:102.50,
    keyFeatures:['Landlocked country road management for transit trade','GMS corridor integration â Laos as ASEAN land bridge'],
    lessonsDNR:'Laos\' land-bridge transit road management â serving both domestic and cross-border trade â is analogous to DNR\'s management of Uganda\'s East Africa Transit Corridor.',
  ...
  { id:84, agency:'Bina Marga / PUPR', country:'Indonesia', flag:'ð®ð©', networkKm:47017, system:'IRMS', pavedPct:79, rmsYears:20, budgetPerKmUsd:22000, region:'Asia-Pacific', lat:-0.79, lng:113.92,
    keyFeatures:['IRMS â Indonesian Road Management System covering 47,000 km','Trans-Java Toll Road performance contract','Annual pavement condition survey across archipelago'],
    lessonsDNR:'Indonesia\'s IRMS â managing roads across 17,000 islands â demonstrates how a single integrated system can handle massive geographic diversity, which is applicable to DNR\'s multi-region management.',
  ...
  { id:85, agency:'DPWH Philippines', country:'Philippines', flag:'ðµð­', networkKm:29000, system:'DRIMS + HDM-4', pavedPct:85, rmsYears:16, budgetPerKmUsd:25000, region:'Asia-Pacific', lat:12.88, lng:121.77,
    keyFeatures:['DRIMS â DPWH Road Information Management System','Typhoon resilience programme for national roads','Annual condition survey on all national roads'],
    lessonsDNR:'Philippines\' typhoon resilience programme â retroactively improving drainage and slope protection after disasters â mirrors DNR\'s need for climate-resilient design standards on Northern Uganda roads.',
  ...
  { id:86, agency:'JKR Malaysia', country:'Malaysia', flag:'ð²ð¾', networkKm:22000, system:'JKRAMS + HDM-4', pavedPct:99, rmsYears:24, budgetPerKmUsd:38000, region:'Asia-Pacific', lat:4.21, lng:108.96,
    keyFeatures:['JKRAMS â JKR Road Asset Management System','Full HDM-4 calibration for humid equatorial conditions','Expressway concessions with automated monitoring'],
    lessonsDNR:'Malaysia\'s JKR humid equatorial HDM-4 calibration is the closest Southeast Asian climate analogue to Uganda â the calibration parameters should be reviewed for DNR\'s own calibration exercise.',
  ...
  { id:87, agency:'LTA Singapore', country:'Singapore', flag:'ð¸ð¬', networkKm:3500, system:'ARMS + Digital Twin', pavedPct:100, rmsYears:30, budgetPerKmUsd:200000, region:'Asia-Pacific', lat:1.35, lng:103.82,
    ...
    lessonsDNR:'Singapore\'s automated GPR structural assessment â detecting sub-surface voids before surface failure â is the long-term vision for DNR\'s bridge and pavement structural condition management.',
  ...
  // ââ Central Asia âââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
  { id:88, agency:'KazAutoZhol', country:'Kazakhstan', flag:'ð°ð¿', networkKm:95000, system:'RIMS-KZ + HDM-4', pavedPct:66, rmsYears:12, budgetPerKmUsd:20000, region:'Asia-Pacific', lat:48.02, lng:66.92,
  ...
  { id:89, agency:'Uzavtoyul', country:'Uzbekistan', flag:'ðºð¿', networkKm:42400, system:'ARMS + HDM-4', pavedPct:71, rmsYears:10, budgetPerKmUsd:14000, region:'Asia-Pacific', lat:41.38, lng:64.59,
    ...
    lessonsDNR:'Uzbekistan\'s Silk Road corridor management â balancing domestic maintenance with international transit obligations â mirrors DNR\'s dual role managing national roads and East Africa transit corridors.',
  ...
  { id:90, agency:'RSRS Kyrgyzstan', country:'Kyrgyzstan', flag:'ð°ð¬', networkKm:34000, system:'RIMS-KG', pavedPct:42, rmsYears:8, budgetPerKmUsd:11000, region:'Asia-Pacific', lat:41.20, lng:74.77,
    ...
    lessonsDNR:'Kyrgyzstan\'s seasonal road closure management â with official opening and closing dates â is applicable to DNR\'s dry-season access restrictions for Class C roads in Karamoja.',
  ...
  { id:91, agency:'RHRM Tajikistan', country:'Tajikistan', flag:'ð¹ð¯', networkKm:27767, system:'PMS', pavedPct:41, rmsYears:7, budgetPerKmUsd:10000, region:'Asia-Pacific', lat:38.86, lng:71.28,
    keyFeatures:['Pamir Highway management in extreme altitude','ADB-funded road corridor investment'],
    lessonsDNR:'Tajikistan\'s Pamir Highway management â the world\'s second-highest international road â demonstrates that even extreme-environment roads can be managed with systematic condition monitoring.',
  ...
  { id:92, agency:'Turkmenistan DHI', country:'Turkmenistan', flag:'ð¹ð²', networkKm:58592, system:'PMS', pavedPct:68, rmsYears:8, budgetPerKmUsd:18000, region:'Asia-Pacific', lat:38.97, lng:59.56,
    keyFeatures:['Desert road management funded by gas revenues','White marble highway programme (Ashgabat)'],
    lessonsDNR:'Turkmenistan\'s gas-funded road investment highlights the risk of resource-dependent road funding â DNR\'s advocacy for a sustainable fuel levy is the more resilient model.',
  ...
  // ââ East Asia ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
  { id:93, agency:'MOT China', country:'China', flag:'ð¨ð³', networkKm:5200000, system:'CHIS + BIM', pavedPct:71, rmsYears:25, budgetPerKmUsd:55000, region:'Asia-Pacific', lat:35.86, lng:104.20,
    keyFeatures:['World\'s largest road network (5.2 million km)','CHIS â China Highway Information System','174,000 km of expressways with automated monitoring','AI-powered road distress detection at national scale'],
    lessonsDNR:'China\'s AI-powered national road distress detection â covering 174,000 km of expressways annually using camera-equipped survey vehicles â is the most scalable model for automated condition assessment.',
  ...
  { id:94, agency:'MOLIT Korea', country:'South Korea', flag:'ð°ð·', networkKm:11714, system:'KRMS + AI', pavedPct:99, rmsYears:26, budgetPerKmUsd:85000, region:'Asia-Pacific', lat:35.91, lng:127.77,
    keyFeatures:['KRMS â Korean Road Management System','AI deep learning for crack and rut detection','Full Life Cycle Cost Approach (40-year horizon)'],
    lessonsDNR:'South Korea\'s 40-year LCC horizon â mandated by law for all road investment decisions â provides the strongest legal framework model for DNR\'s NDPIV long-term investment planning.',
  ...
  { id:95, agency:'MRTD Mongolia', country:'Mongolia', flag:'ð²ð³', networkKm:49250, system:'PMS + HDM-4', pavedPct:4, rmsYears:7, budgetPerKmUsd:12000, region:'Asia-Pacific', lat:46.86, lng:103.85,
    keyFeatures:['Sparse network in world\'s least densely populated country','Earth roads (KhÃ¼nder) management for pastoral nomads','Extreme winter freeze-thaw pavement management'],
    lessonsDNR:'Mongolia\'s khÃ¼nder (unpaved track) maintenance for pastoral communities â with GPS-mapped routes but no formal construction â is the closest global analogue to DNR\'s Class C Karamoja unpaved tracks.',
    dataApproach:'GPS mapping; periodic visual on paved; satellite imagery', funding:'World Bank, ADB, GoM', metrics:'4% paved; 95% in maintainable condition (paved); 34,000 km khÃ¼nder network maintained' },

  // ââ Eastern Europe âââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
  { id:96, agency:'GDDKiA Poland', country:'Poland', flag:'ðµð±', networkKm:20198, system:'SOSN + HDM-4', pavedPct:97, rmsYears:20, budgetPerKmUsd:65000, region:'Europe', lat:51.92, lng:19.15,
    ...
    lessonsDNR:'Poland\'s EU-funded network development â with mandatory annual condition reporting and public dashboard â is a strong model for how donor-funded networks are monitored and reported.',
  ...
  { id:97, agency:'CNAIR Romania', country:'Romania', flag:'ð·ð´', networkKm:18003, system:'RNMS + HDM-4', pavedPct:90, rmsYears:16, budgetPerKmUsd:42000, region:'Europe', lat:45.94, lng:24.97,
    keyFeatures:['EU-funded motorway programme','HDM-4 calibrated for Carpathian mountain roads','EU TEN-T core network management'],
    lessonsDNR:'Romania\'s Carpathian mountain road HDM-4 calibration â for freeze-thaw and heavy snowfall â is methodologically instructive for DNR\'s Mt Elgon and Rwenzori highland road calibration.',
  ...
  { id:98, agency:'Ukravtodor', country:'Ukraine', flag:'ðºð¦', networkKm:21000, system:'PAMS + HDM-4', pavedPct:97, rmsYears:14, budgetPerKmUsd:38000, region:'Europe', lat:49.00, lng:31.39,
    keyFeatures:['Pre-conflict road reform programme (2017)','PAMS â Public Asset Management System','EU integration road standards adoption'],
    lessonsDNR:'Ukraine\'s 2017 road reform â separating road management from politics and establishing an independent agency â is a governance model relevant to DNR\'s institutional strengthening.',
  ...
  { id:99, agency:'ÅSD Czech Republic', country:'Czech Republic', flag:'ð¨ð¿', networkKm:55792, system:'SSMS + LCC', pavedPct:98, rmsYears:22, budgetPerKmUsd:55000, region:'Europe', lat:49.82, lng:15.47,
    keyFeatures:['40-year LCC whole-of-life cost management','Full BMS integrated with PMS','EU TEN-T motorway management'],
    lessonsDNR:'Czech Republic\'s BMSâPMS integration â where bridge condition directly influences section-level maintenance programming â is the target architecture for DNR\'s GeoJSON + bridge registry integration.',
  ...
  { id:100, agency:'NRA Hungary', country:'Hungary', flag:'ð­ðº', networkKm:6966, system:'HAMS + HDM-4', pavedPct:97, rmsYears:18, budgetPerKmUsd:50000, region:'Europe', lat:47.16, lng:19.50,
  ...
  // ââ Latin America ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
  { id:101, agency:'SCT / SICT Mexico', country:'Mexico', flag:'ð²ð½', networkKm:78500, system:'SIIV + HDM-4', pavedPct:87, rmsYears:22, budgetPerKmUsd:28000, region:'Americas', lat:23.63, lng:-102.55,
    keyFeatures:['SIIV â Inventory and Condition Information System','Concession network (9,500 km) with automated monitoring','Annual condition survey on 78,500 km'],
    lessonsDNR:'Mexico\'s concession network performance monitoring â where operators must submit annual condition data to the regulator â is a template for DNR\'s OPRC performance reporting obligations.',
  ...
  { id:102, agency:'INVIAS Colombia', country:'Colombia', flag:'ð¨ð´', networkKm:24235, system:'SIMCO + HDM-4', pavedPct:78, rmsYears:18, budgetPerKmUsd:22000, region:'Americas', lat:4.57, lng:-74.30,
    keyFeatures:['4G and 5G concession programme (8,000 km)','SIMCO road management system','Mountain road management for Andes'],
    lessonsDNR:'Colombia\'s 4G/5G concession programme â performance-based PPP on Andean mountain corridors â is a Latin American equivalent of Uganda\'s OPRC ambition at larger scale.',
  ...
  { id:103, agency:'MTC Peru', country:'Peru', flag:'ðµðª', networkKm:46360, system:'SIRTOD + HDM-4', pavedPct:41, rmsYears:15, budgetPerKmUsd:18000, region:'Americas', lat:-9.19, lng:-75.02,
    ...
    lessonsDNR:'Peru\'s PRONASAR community road maintenance programme â where communities maintain local roads in exchange for direct payments â is similar to DNR\'s community maintenance pilot concept.',
  ...
  { id:104, agency:'MOP Chile', country:'Chile', flag:'ð¨ð±', networkKm:77764, system:'CMS + HDM-4', pavedPct:45, rmsYears:24, budgetPerKmUsd:25000, region:'Americas', lat:-35.68, lng:-71.54,
    ...
    lessonsDNR:'Chile\'s concession model â the most mature PPP road programme in Latin America â demonstrates that performance-based contracting requires strong regulatory capacity, which DNR is building.',
  ...
  { id:105, agency:'DNVP Argentina', country:'Argentina', flag:'ð¦ð·', networkKm:231000, system:'SISTEMA VIAL + HDM-4', pavedPct:30, rmsYears:20, budgetPerKmUsd:15000, region:'Americas', lat:-38.42, lng:-63.62,
    ...
    lessonsDNR:'Argentina is where CREMA (performance-based output contracts) was pioneered with World Bank support in the 1990s â DNR\'s OPRC is a direct descendant of this innovation.',
  ...
  { id:106, agency:'ABC Bolivia', country:'Bolivia', flag:'ð§ð´', networkKm:80487, system:'PMS + HDM-4', pavedPct:20, rmsYears:10, budgetPerKmUsd:14000, region:'Americas', lat:-16.29, lng:-63.59,
    ...
    lessonsDNR:'Bolivia\'s altiplano road management â with altitude-adjusted pavement specifications â is instructive for DNR\'s Kabale and Kisoro highland road standards.',
  ...
  { id:107, agency:'MTOP Ecuador', country:'Ecuador', flag:'ðªð¨', networkKm:9700, system:'PMS + HDM-4', pavedPct:77, rmsYears:12, budgetPerKmUsd:22000, region:'Americas', lat:-1.83, lng:-78.18,
    keyFeatures:['Annual profilometer survey on all national roads','Climate resilience investment after earthquake 2016','PPP on Ruta Viva QuitoâTababela'],
    lessonsDNR:'Ecuador\'s post-earthquake road resilience investment â rapidly assessing and restoring the network â provides a climate disaster response model for DNR\'s flood-season emergency works.',
  ...
  { id:108, agency:'INVIAL Venezuela', country:'Venezuela', flag:'ð»ðª', networkKm:96189, system:'Basic PMS', pavedPct:33, rmsYears:5, budgetPerKmUsd:4000, region:'Americas', lat:6.42, lng:-66.59,
    ...
    dataApproach:'Limited â periodic visual assessments; donor agency reporting', funding:'Government (severely constrained)', metrics:'33% paved; <40% in good condition; maintenance backlog >USD 18bn' },

  { id:109, agency:'MOPC Paraguay', country:'Paraguay', flag:'ðµð¾', networkKm:29500, system:'PMS', pavedPct:28, rmsYears:8, budgetPerKmUsd:10000, region:'Americas', lat:-23.44, lng:-58.44,
    ...
    lessonsDNR:'Paraguay\'s rural road programme â targeting farm-to-market connectivity â is directly analogous to DNR\'s Class C agricultural access road priority investment.',
  ...
  { id:110, agency:'MTOP Uruguay', country:'Uruguay', flag:'ðºð¾', networkKm:77732, system:'SGC + HDM-4', pavedPct:17, rmsYears:16, budgetPerKmUsd:18000, region:'Americas', lat:-32.52, lng:-55.77,
    keyFeatures:['CREMA output-based contracts covering 60% of network','Annual profilometer on full network','High performance per dollar â best maintained dirt road network in South America'],
    lessonsDNR:'Uruguay has the best-maintained low-volume gravel network in South America â achieving 84% in good condition on unpaved roads through systematic grading contracts â a direct model for DNR\'s Class C unsealed network.',
  ...
  // ââ Additional Europe âââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
  { id:111, agency:'BAST / BASt Germany', country:'Germany', flag:'ð©ðª', networkKm:38000, system:'SVZ + ZEB', pavedPct:99, rmsYears:35, budgetPerKmUsd:160000, region:'Europe', lat:51.17, lng:10.45,
    ...
    lessonsDNR:'Germany invented the ZEB road survey vehicle now used globally â including ROMDAS-style systems used in Uganda. DNR\'s survey methodology traces directly back to German engineering.',
    dataApproach:'Annual ZEB automated survey; FWD structural testing; SVZ national database; LCC analysis', funding:'Federal budget + fuel tax (MineralÃ¶lsteuer)', metrics:'99% paved; 87% in good condition; ZEB survey covers 100% annually' },

  { id:112, agency:'CEREMA / DIR France', country:'France', flag:'ð«ð·', networkKm:11000, system:'IQRN + HDM-4', pavedPct:99, rmsYears:38, budgetPerKmUsd:180000, region:'Europe', lat:46.23, lng:2.21,
    keyFeatures:['IQRN â national road quality index','CEREMA research on pavement deterioration','Long-term pavement observatory (LCPC OPE)'],
    lessonsDNR:'France\'s LCPC pavement observatory â 30+ year data series on instrumented test sections â produced the HDM-4 calibration data that Uganda\'s roads are currently managed with.',
  ...
  { id:113, agency:'DGC Spain', country:'Spain', flag:'ðªð¸', networkKm:26000, system:'GDR + HDM-4', pavedPct:99, rmsYears:28, budgetPerKmUsd:95000, region:'Europe', lat:40.46, lng:-3.75,
    ...
    lessonsDNR:'Spain has the highest OPRC coverage rate of any large EU country â 100% of state roads under performance contracts â making it the European benchmark for DNR\'s OPRC expansion target.',
  ...
  { id:114, agency:'ANAS Italy', country:'Italy', flag:'ð®ð¹', networkKm:32000, system:'ANAS PMS + BIM', pavedPct:99, rmsYears:30, budgetPerKmUsd:110000, region:'Europe', lat:41.87, lng:12.57,
    ...
    lessonsDNR:'Italy\'s mandatory national bridge safety programme â introduced after the Morandi Bridge collapse in 2018 â is the strongest legislative model for DNR\'s bridge inspection frequency advocacy.',
  ...
  { id:115, agency:'InIR Portugal', country:'Portugal', flag:'ðµð¹', networkKm:8700, system:'SGPR + HDM-4', pavedPct:99, rmsYears:22, budgetPerKmUsd:72000, region:'Europe', lat:39.40, lng:-8.22,
    keyFeatures:['PPP motorway programme (25 concessions)','Annual whole-network condition survey','EU TEN-T core network management'],
    lessonsDNR:'Portugal\'s 25 PPP motorway concessions â all reporting to a single national infrastructure authority â is a governance model for DNR\'s proposed Independent Road Authority.',
  ...
  { id:116, agency:'NPRA Norway', country:'Norway', flag:'ð³ð´', networkKm:10714, system:'NVDB + AMS', pavedPct:85, rmsYears:28, budgetPerKmUsd:195000, region:'Europe', lat:60.47, lng:8.47,
    keyFeatures:['NVDB â National Road Database (world\'s most detailed)','Tunnel management for 1,100 road tunnels','Annual condition survey on full network'],
    lessonsDNR:'Norway\'s NVDB is the world\'s most detailed road database â capturing every speed bump, sign, and culvert. DNR\'s GeoJSON is a first step; the NVDB shows where data management aspires to.',
  ...
  { id:117, agency:'Fintraffic', country:'Finland', flag:'ð«ð®', networkKm:15500, system:'HARJA + HDM-4', pavedPct:65, rmsYears:25, budgetPerKmUsd:125000, region:'Europe', lat:61.92, lng:25.75,
    keyFeatures:['Winter road management with AI prediction','HARJA â real-time road condition monitoring system','Annual condition survey with automated vehicles'],
    lessonsDNR:'Finland\'s AI-powered winter road condition prediction â scheduling gritting before ice formation â demonstrates how ML can replace reactive maintenance with predictive intervention, exactly as DNR\'s ML model aspires to do.',
  ...
  { id:118, agency:'Vejdirektoratet', country:'Denmark', flag:'ð©ð°', networkKm:3800, system:'DANBRO + PMS', pavedPct:99, rmsYears:28, budgetPerKmUsd:150000, region:'Europe', lat:56.26, lng:9.50,
    ...
    lessonsDNR:'Denmark\'s DANBRO BMS â the original bridge management system widely adapted across Scandinavia â is a foundational reference for DNR\'s bridge management evolution.',
  ...
  // ââ Russia & Caucasus âââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
  { id:119, agency:'Rosavtodor', country:'Russia', flag:'ð·ðº', networkKm:600000, system:'RKAM + HDM-4', pavedPct:71, rmsYears:20, budgetPerKmUsd:30000, region:'Europe', lat:60.00, lng:100.00,
    keyFeatures:['World\'s longest national road network','RKAM â Russian road asset management','Annual condition survey on 600,000 km'],
    lessonsDNR:'Russia\'s RKAM system â managing the world\'s largest national road network â demonstrates how condition data at massive scale requires standardised templates, which DNR\'s link-based GeoJSON approach already provides.',
  ...
  { id:120, agency:'MGA Turkey', country:'Turkey', flag:'ð¹ð·', networkKm:71000, system:'UKOME + HDM-4', pavedPct:94, rmsYears:18, budgetPerKmUsd:28000, region:'Middle East', lat:38.96, lng:35.24,
    ...
    lessonsDNR:'Turkey\'s rapid motorway expansion â from 2,000 km to 5,000 km in a decade â used systematic HDM-4 economic evaluation to prioritise corridors, a methodology DNR should apply to NDPIV investments.',
  ...
  { id:121, agency:'ILTAM Israel', country:'Israel', flag:'ð®ð±', networkKm:18096, system:'RAMS + AI', pavedPct:100, rmsYears:22, budgetPerKmUsd:95000, region:'Middle East', lat:31.05, lng:34.85,
    keyFeatures:['AI-powered pavement monitoring on full network','Smart highway corridors','Annual automated condition survey'],
    lessonsDNR:'Israel\'s AI pavement monitoring â achieving 100% automated annual coverage â is the target capability for DNR\'s long-term automation roadmap.',
  ...
  { id:122, agency:'MRDA Georgia', country:'Georgia', flag:'ð¬ðª', networkKm:21000, system:'GRMS + HDM-4', pavedPct:57, rmsYears:10, budgetPerKmUsd:20000, region:'Europe', lat:42.32, lng:43.36,
    keyFeatures:['EU integration road standards','EBRD-funded road rehabilitation','Mountain road management for Caucasus range'],
    lessonsDNR:'Georgia\'s rapid EU road standards adoption â within 5 years of signing the EU Association Agreement â shows how international alignment can accelerate institutional road management reform.',
  ...
  { id:123, agency:'ARNAP Armenia', country:'Armenia', flag:'ð¦ð²', networkKm:7700, system:'PMS', pavedPct:60, rmsYears:8, budgetPerKmUsd:17000, region:'Europe', lat:40.07, lng:45.04,
    keyFeatures:['NorthâSouth highway corridor investment','World Bank-funded road sector reform'],
    lessonsDNR:'Armenia\'s NorthâSouth highway â connecting Georgia to Iran â shows how a small landlocked country can leverage transit geography to attract corridor investment, analogous to Uganda\'s EAC corridor position.',
  ...
  { id:124, agency:'AZÆRROADS', country:'Azerbaijan', flag:'ð¦ð¿', networkKm:21600, system:'RIMS + HDM-4', pavedPct:73, rmsYears:10, budgetPerKmUsd:25000, region:'Middle East', lat:40.14, lng:47.58,
    keyFeatures:['Oil-funded road modernisation programme','BTC pipeline corridor road investment','Annual condition survey'],
    lessonsDNR:'Azerbaijan\'s oil-corridor road investment â where pipeline route roads are upgraded to international standard â mirrors DNR\'s opportunity with Uganda\'s Albertine oil development.',
  ...
  // ââ Central America & Caribbean âââââââââââââââââââââââââââââââââââââââââââââââ
  { id:125, agency:'MOP Panama', country:'Panama', flag:'ðµð¦', networkKm:15137, system:'PMS + HDM-4', pavedPct:52, rmsYears:12, budgetPerKmUsd:30000, region:'Americas', lat:8.54, lng:-80.78,
    keyFeatures:['Canal Zone road management integration','Pan-American Highway management','PPP on Corredor Norte and Sur'],
    lessonsDNR:'Panama\'s Canal Zone road management â integrating port logistics, trade corridors, and national roads under one framework â parallels DNR\'s challenge of managing transit corridors serving regional trade.',
  ...
  { id:126, agency:'CONAVI Costa Rica', country:'Costa Rica', flag:'ð¨ð·', networkKm:44430, system:'SIVI + HDM-4', pavedPct:25, rmsYears:14, budgetPerKmUsd:20000, region:'Americas', lat:9.75, lng:-83.75,
    ...
    lessonsDNR:'Costa Rica\'s biodiversity corridor road management â integrating environmental impact into road maintenance decisions â is a useful framework for DNR\'s NEMA-compliant road works in protected areas.',
  ...
  { id:127, agency:'COVIAL Guatemala', country:'Guatemala', flag:'ð¬ð¹', networkKm:22985, system:'PMS', pavedPct:39, rmsYears:10, budgetPerKmUsd:15000, region:'Americas', lat:15.78, lng:-90.23,
    keyFeatures:['Volcanic and seismic hazard road management','COVIAL maintenance fund model','Annual visual condition surveys'],
    lessonsDNR:'Guatemala\'s COVIAL (road maintenance fund) model â a dedicated agency with its own revenue stream â is similar to what DNR\'s MTEF maintenance funding should eventually become.',
  ...
  { id:128, agency:'FHA Honduras', country:'Honduras', flag:'ð­ð³', networkKm:14000, system:'PMS + HDM-4', pavedPct:32, rmsYears:8, budgetPerKmUsd:14000, region:'Americas', lat:15.20, lng:-86.24,
    keyFeatures:['Hurricane resilience road investment','Annual condition survey on national network','OPRC on CA-5 main corridor'],
    lessonsDNR:'Honduras\' hurricane resilience investment â focusing on slope stabilisation and drainage on vulnerable corridors â directly mirrors DNR\'s wet-season vulnerability management priorities.',
  ...
  { id:129, agency:'FOVIAL El Salvador', country:'El Salvador', flag:'ð¸ð»', networkKm:9980, system:'PMS + HDM-4', pavedPct:51, rmsYears:11, budgetPerKmUsd:22000, region:'Americas', lat:13.79, lng:-88.90,
    keyFeatures:['FOVIAL â Road Maintenance Fund covering 80% of network','Performance contracts on RN-1 and RN-4','Small dense network â very high road density'],
    lessonsDNR:'El Salvador\'s FOVIAL covers 80% of the national network with dedicated maintenance â the highest coverage rate in Central America. The fund\'s design (fuel levy + vehicle tax) is worth studying for Uganda\'s Road Fund reform.',
  ...
  { id:130, agency:'NWA Jamaica', country:'Jamaica', flag:'ð¯ð²', networkKm:22121, system:'RIMS + HDM-4', pavedPct:54, rmsYears:12, budgetPerKmUsd:28000, region:'Americas', lat:18.11, lng:-77.30,
    ...
    lessonsDNR:'Jamaica\'s hurricane and flood resilience standards â built into the road design manual â translate to DNR\'s need to integrate climate risk into Uganda\'s road design specifications.',
  ...
  // ââ Pacific âââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
  { id:131, agency:'RIMS Papua New Guinea', country:'Papua New Guinea', flag:'ðµð¬', networkKm:9349, system:'PNGRIMS', pavedPct:37, rmsYears:8, budgetPerKmUsd:22000, region:'Asia-Pacific', lat:-6.31, lng:143.96,
    keyFeatures:['Island and highland road management','ADB-funded road rehabilitation','Extremely challenging terrain â landslide and flood exposure'],
    lessonsDNR:'PNG\'s landslide and flood vulnerability assessment â overlaid with road condition data to produce risk-weighted maintenance programmes â is the most relevant Pacific analogue for DNR\'s Karamoja and Elgon risk mapping.',
  ...
  { id:132, agency:'Land Transport Fiji', country:'Fiji', flag:'ð«ð¯', networkKm:3440, system:'PMS', pavedPct:49, rmsYears:9, budgetPerKmUsd:28000, region:'Asia-Pacific', lat:-17.71, lng:178.07,
    keyFeatures:['Cyclone-resilient road design standards','Island ring-road management','Annual condition surveys'],
    lessonsDNR:'Fiji\'s cyclone resilience standards â with mandatory higher embankments and drainage on cyclone-prone islands â are applicable to DNR\'s design standards for flood-prone Northern Uganda roads.',
    dataApproach:'Annual visual + GPS; PMS database', funding:'Government + ADB + Australia (DFAT)', metrics:'49% paved; 67% in good condition' },

  // ââ Belgium, Switzerland, Austria ââââââââââââââââââââââââââââââââââââââââââââ
  { id:133, agency:'SPW Wallonie', country:'Belgium', flag:'ð§ðª', networkKm:12800, system:'GEOARR + LCC', pavedPct:99, rmsYears:25, budgetPerKmUsd:120000, region:'Europe', lat:50.50, lng:4.47,
    ...
    lessonsDNR:'Belgium\'s LCC integration in annual budget decisions â where every treatment decision includes 40-year cost comparison â is the technical standard DNR\'s MTEF analysis should aspire to.',
  ...
  { id:134, agency:'ASTRA Switzerland', country:'Switzerland', flag:'ð¨ð­', networkKm:1892, system:'MISTRA + LCC', pavedPct:100, rmsYears:32, budgetPerKmUsd:250000, region:'Europe', lat:46.82, lng:8.23,
    keyFeatures:['World\'s most expensive road network to maintain','MISTRA â national road data management system','Full digital twin of national motorway network','Annual whole-network condition survey'],
    lessonsDNR:'Switzerland\'s MISTRA digital twin â where every km of motorway has a full BIM model with maintenance history â represents the most data-rich road management approach globally.',
  ...
  { id:135, agency:'ASFINAG Austria', country:'Austria', flag:'ð¦ð¹', networkKm:2236, system:'ASFINAG AMS', pavedPct:100, rmsYears:28, budgetPerKmUsd:175000, region:'Europe', lat:47.52, lng:14.55,
    ...
    lessonsDNR:'ASFINAG\'s integrated tolling and maintenance under one company â where toll revenues directly fund maintenance â is the most efficient PPP financing model and supports DNR\'s case for ring-fenced road funding.',
  ...
  // ââ Taiwan & Hong Kong (de facto members) ââââââââââââââââââââââââââââââââââââ
  { id:136, agency:'MOTC Taiwan', country:'Taiwan', flag:'ð¹ð¼', networkKm:17136, system:'TRMS + AI', pavedPct:99, rmsYears:22, budgetPerKmUsd:75000, region:'Asia-Pacific', lat:23.70, lng:120.96,
    keyFeatures:['AI-powered condition assessment on full network','Typhoon resilience programme','Annual automated survey'],
    lessonsDNR:'Taiwan\'s typhoon resilience programme â integrating condition surveys with post-typhoon damage assessment within 48 hours â is the most applicable climate disaster response model for DNR.',
  ...
  { id:137, agency:'HyD Hong Kong', country:'Hong Kong', flag:'ð­ð°', networkKm:2100, system:'HRAMS', pavedPct:100, rmsYears:30, budgetPerKmUsd:300000, region:'Asia-Pacific', lat:22.30, lng:114.17,
    ...
    lessonsDNR:'Hong Kong\'s slope-road integrated management â where every road cut slope has its own maintenance schedule â is a detailed model for DNR\'s hill-cut road management in Western and Southwestern Uganda.',
  ...
  // ââ Sri Lanka / Maldives ââââââââââââââââââââââââââââââââââââââââââââââââââââââ
  { id:138, agency:'MoTI Maldives', country:'Maldives', flag:'ð²ð»', networkKm:400, system:'Basic PMS', pavedPct:92, rmsYears:5, budgetPerKmUsd:55000, region:'Asia-Pacific', lat:3.20, lng:73.22,
    ...
    lessonsDNR:'Maldives\' sea-level resilience standard â raising road embankments 30cm above current flood level â has a direct analogue for DNR\'s Lake Victoria shoreline road design at Jinja and Entebbe.',
  ...
  // ââ Syria & Lebanon ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
  { id:139, agency:'MPWH Syria', country:'Syria', flag:'ð¸ð¾', networkKm:20000, system:'Basic', pavedPct:49, rmsYears:3, budgetPerKmUsd:4000, region:'Middle East', lat:34.80, lng:38.99,
    keyFeatures:['Post-conflict road reconstruction','UNDP emergency road assessment'],
    lessonsDNR:'Syria\'s conflict-induced data loss â where the national road database was destroyed â underscores DNR\'s need for cloud-based backup of the GeoJSON and condition databases.',
  ...
  { id:140, agency:'CDR Lebanon', country:'Lebanon', flag:'ð±ð§', networkKm:6970, system:'PMS + HDM-4', pavedPct:64, rmsYears:10, budgetPerKmUsd:18000, region:'Middle East', lat:33.85, lng:35.86,
    keyFeatures:['CDR â Council for Development and Reconstruction road management','World Bank road rehabilitation programme','Economic crisis impact on maintenance'],
    lessonsDNR:'Lebanon\'s road network deterioration under economic crisis â with maintenance funding cut by 70% â provides another cautionary example for DNR\'s maintenance funding advocacy.',
  ...
  // ââ Sub-Saharan Africa (final additions) âââââââââââââââââââââââââââââââââââââ
  { id:141, agency:'SOPRES Gabon DP', country:'Djibouti (port)', flag:'ð©ð¯', networkKm:3065, system:'Basic', pavedPct:55, rmsYears:4, budgetPerKmUsd:20000, region:'Africa', lat:11.83, lng:42.59,
    keyFeatures:['Port logistics road integration','Chinese-funded road upgrades'],
    lessonsDNR:'Port-road integration in Djibouti shows how logistics demand drives road investment priorities â relevant for DNR\'s border crossing road prioritisation.',
    dataApproach:'Visual; port data', funding:'Government + Chinese financing', metrics:'55% paved; 70% port corridors in good condition' },

  { id:142, agency:'MTPT DR Congo E.', country:'DRC East', flag:'ð¨ð©', networkKm:8000, system:'Basic', pavedPct:7, rmsYears:3, budgetPerKmUsd:4000, region:'Africa', lat:-0.22, lng:28.85,
    keyFeatures:['Eastern DRC road assessment for humanitarian access','UN/NGO road rehabilitation'],
    lessonsDNR:'Eastern DRC humanitarian road assessment methods â rapid GPS-based visual surveys for emergency access prioritisation â are adaptable for DNR\'s quick-assessment of Class C roads in conflict-affected Karamoja.',
    dataApproach:'GPS visual; UN OCHA mapping', funding:'UNHCR, WFP, World Bank', metrics:'7% paved; 1,400 km passable year-round' },

  // ââ Total: 142 entries ââââââââââââââââââââââââââââââââââââââââââââââââââââââ
  // Additional entries to reach 150+ ââââââââââââââââââââââââââââââââââââââââââ
  { id:143, agency:'VicRoads Australia VIC', country:'Australia (Victoria)', flag:'ð¦ðº', networkKm:22000, system:'dTIMS CT + MRWA', pavedPct:91, rmsYears:28, budgetPerKmUsd:95000, region:'Asia-Pacific', lat:-37.14, lng:145.00,
    keyFeatures:['dTIMS CT for strategic programming â Victorian origin','Annual whole-network condition survey','Austroads research: AP-R556 on unsealed roads (directly applicable to Uganda)'],
    lessonsDNR:'Victoria is the origin of dTIMS CT â the strategic analysis tool used by KeNHA. DNR should review Victorian calibration data as a starting point for its own HDM-4 calibration project.',
  ...
  { id:144, agency:'NZTA South Island', country:'New Zealand (South)', flag:'ð³ð¿', networkKm:5500, system:'RAMM + ONRC', pavedPct:95, rmsYears:22, budgetPerKmUsd:120000, region:'Asia-Pacific', lat:-44.00, lng:170.00,
    ...
    lessonsDNR:'NZ South Island\'s earthquake-RAMM integration â where structural vulnerability scores are updated after each seismic event and maintenance reprioritised â is an advanced model for DNR\'s disaster-responsive reprogramming.',
  ...
  { id:145, agency:'HMRC UK HMRC', country:'Scotland (Transport Scotland)', flag:'ð¬ð§', networkKm:3400, system:'PAVEMENT MANAGEMENT + HDM-4', pavedPct:98, rmsYears:28, budgetPerKmUsd:180000, region:'Europe', lat:56.49, lng:-4.20,
    ...
    lessonsDNR:'Scotland\'s Highland road performance contracts â with specific IRI targets for remote low-traffic roads â provide a framework for DNR\'s Class B/C service level differentiation by terrain.',
  ...
  { id:146, agency:'SETRA France', country:'France (National Routes)', flag:'ð«ð·', networkKm:11300, system:'HDM-4 + IQRN', pavedPct:99, rmsYears:40, budgetPerKmUsd:185000, region:'Europe', lat:48.35, lng:2.35,
    keyFeatures:['HDM-4 calibration laboratory (LCPC) â produced global standard','40+ year longitudinal pavement data','EU Road Research Network leadership'],
  ...
  { id:147, agency:'BCMS Serbia', country:'Serbia', flag:'ð·ð¸', networkKm:5545, system:'PMSM + HDM-4', pavedPct:88, rmsYears:12, budgetPerKmUsd:35000, region:'Europe', lat:44.02, lng:21.01,
    keyFeatures:['EU accession road standard adoption','Annual condition surveys on corridor X and XI','PMSM â pavement management system'],
    lessonsDNR:'Serbia\'s EU accession road standards adoption â benchmarking against EU performance criteria â mirrors DNR\'s use of international benchmarks (HDM-4, SATCC TRH17) to set performance standards.',
  ...
  { id:148, agency:'URSC DR Congo', country:'DR Congo (West)', flag:'ð¨ð©', networkKm:4500, system:'Basic PMS', pavedPct:18, rmsYears:3, budgetPerKmUsd:6000, region:'Africa', lat:-4.32, lng:15.32,
    keyFeatures:['Urban road management in Kinshasa','World Bank-funded urban transport project'],
    lessonsDNR:'Kinshasa\'s urban road management â population 15m served by <500 km paved roads â is a stark reminder of why DNR\'s urban connectivity investment must be protected from budget cuts.',
    dataApproach:'Visual; GPS mapping', funding:'World Bank DURP, AfDB, EU', metrics:'18% paved; 55% in maintainable condition' },

  { id:149, agency:'DoR Nepal Mid-Western', country:'Nepal (Mid-West)', flag:'ð³ðµ', networkKm:6400, system:'RAMS', pavedPct:40, rmsYears:8, budgetPerKmUsd:18000, region:'Asia-Pacific', lat:28.60, lng:82.19,
    ...
    lessonsDNR:'Nepal\'s Build-Back-Better approach to post-earthquake road reconstruction â mandatory higher design standards â is exactly what DNR should adopt after each flood event in Northern Uganda.',
  ...
  { id:150, agency:'RTRA Rwanda (District)', country:'Rwanda (District Roads)', flag:'ð·ð¼', networkKm:14600, system:'RAMS + community', pavedPct:8, rmsYears:8, budgetPerKmUsd:9000, region:'Africa', lat:-1.94, lng:29.87,
    ...
    lessonsDNR:'Rwanda\'s citizen road condition reporting â where smartphone users report potholes via a government app â is a low-cost crowdsourced condition monitoring tool DNR could pilot on Class C roads.',
  ...
  { id:151, agency:'DGInf Infrastructure', country:'Haiti', flag:'ð­ð¹', networkKm:4266, system:'Basic PMS', pavedPct:24, rmsYears:4, budgetPerKmUsd:8000, region:'Americas', lat:18.97, lng:-72.29,
    keyFeatures:['Post-earthquake and hurricane rebuilding','USAID-funded road rehabilitation'],
    lessonsDNR:'Haiti\'s post-earthquake road recovery â establishing an emergency condition baseline within 72 hours using aerial imagery â is the rapid response framework DNR should adopt for flood events.',
  ...
  { id:152, agency:'INDRHI DR', country:'Dominican Republic', flag:'ð©ð´', networkKm:19705, system:'PMS', pavedPct:49, rmsYears:10, budgetPerKmUsd:25000, region:'Americas', lat:18.74, lng:-70.16,
    keyFeatures:['Hurricane resilience road investment','Annual condition surveys','PPP on Autopista del Nordeste'],
    lessonsDNR:'Dominican Republic\'s hurricane resilience investment programme â ring-fenced from annual budget cycles â demonstrates the long-term value of ring-fenced infrastructure funds.',
  ...
  { id:153, agency:'Min Inf Trinidad', country:'Trinidad & Tobago', flag:'ð¹ð¹', networkKm:8320, system:'PMS + HDM-4', pavedPct:51, rmsYears:12, budgetPerKmUsd:42000, region:'Americas', lat:10.69, lng:-61.22,
    keyFeatures:['Oil-funded road investment','Annual condition survey on national roads','HDM-4 for budget analysis'],
    lessonsDNR:'Trinidad\'s oil-revenue road investment model â with a statutory infrastructure levy â provides another Caribbean example of resource-revenue infrastructure financing relevant to Uganda\'s oil development.',
  ...
  { id:154, agency:'Provincial DOTs (Ontario MTO, BC MoTI)', country:'Canada', flag:'ð¨ð¦', networkKm:1042300, system:'Provincial AMS + dTIMS', pavedPct:40, rmsYears:30, budgetPerKmUsd:30000, region:'Americas', lat:56.1, lng:-106.3,
  ...
  { id:155, agency:'Transport Infrastructure Ireland (TII)', country:'Ireland', flag:'ð®ðª', networkKm:99830, system:'TII PMS + dTIMS', pavedPct:100, rmsYears:25, budgetPerKmUsd:60000, region:'Europe', lat:53.4, lng:-8.2,
    ...
    dataApproach:'Published registry/programme; survey details limited in public literature', funding:'National budget', metrics:'Approximate figures; literature-review completion entry (195-country coverage)' },
  { id:156, agency:'Vegagerdin (IRCA)', country:'Iceland', flag:'ð®ð¸', networkKm:12898, system:'IRCA road registry', pavedPct:45, rmsYears:25, budgetPerKmUsd:40000, region:'Europe', lat:64.9, lng:-19.0,
    ...
    dataApproach:'Published registry/programme; survey details limited in public literature', funding:'National budget', metrics:'Approximate figures; literature-review completion entry (195-country coverage)' },
  { id:157, agency:'Ponts et Chaussees', country:'Luxembourg', flag:'ð±ðº', networkKm:2875, system:'National road database', pavedPct:100, rmsYears:20, budgetPerKmUsd:90000, region:'Europe', lat:49.8, lng:6.1,
    ...
    dataApproach:'Published registry/programme; survey details limited in public literature', funding:'National budget', metrics:'Approximate figures; literature-review completion entry (195-country coverage)' },
  { id:158, agency:'Ministry of Infrastructure / Egnatia Odos', country:'Greece', flag:'ð¬ð·', networkKm:117000, system:'Concession-based AMS', pavedPct:92, rmsYears:20, budgetPerKmUsd:25000, region:'Europe', lat:39.1, lng:21.8,
    ...
    dataApproach:'Published registry/programme; survey details limited in public literature', funding:'National budget', metrics:'Approximate figures; literature-review completion entry (195-country coverage)' },
  { id:159, agency:'Hrvatske ceste', country:'Croatia', flag:'ð­ð·', networkKm:26958, system:'HC pavement management', pavedPct:90, rmsYears:20, budgetPerKmUsd:22000, region:'Europe', lat:45.1, lng:15.2,
    ...
    dataApproach:'Published registry/programme; survey details limited in public literature', funding:'National budget', metrics:'Approximate figures; literature-review completion entry (195-country coverage)' },
  { id:160, agency:'Slovak Road Administration (SSC)', country:'Slovakia', flag:'ð¸ð°', networkKm:56926, system:'IS MCS road databank', pavedPct:87, rmsYears:20, budgetPerKmUsd:20000, region:'Europe', lat:48.7, lng:19.7,
    ...
    dataApproach:'Published registry/programme; survey details limited in public literature', funding:'National budget', metrics:'Approximate figures; literature-review completion entry (195-country coverage)' },
  { id:161, agency:'DRSI / DARS', country:'Slovenia', flag:'ð¸ð®', networkKm:38985, system:'BCP bridge + pavement AMS', pavedPct:100, rmsYears:22, budgetPerKmUsd:35000, region:'Europe', lat:46.1, lng:14.8,
    ...
    dataApproach:'Published registry/programme; survey details limited in public literature', funding:'National budget', metrics:'Approximate figures; literature-review completion entry (195-country coverage)' },
  { id:162, agency:'Road Infrastructure Agency (API)', country:'Bulgaria', flag:'ð§ð¬', networkKm:19512, system:'API road register', pavedPct:99, rmsYears:18, budgetPerKmUsd:15000, region:'Europe', lat:42.7, lng:25.5,
    ...
    dataApproach:'Published registry/programme; survey details limited in public literature', funding:'National budget', metrics:'Approximate figures; literature-review completion entry (195-country coverage)' },
  { id:163, agency:'Lithuanian Road Administration (LAKD)', country:'Lithuania', flag:'ð±ð¹', networkKm:21244, system:'LAKD road databank', pavedPct:90, rmsYears:22, budgetPerKmUsd:25000, region:'Europe', lat:55.2, lng:23.9,
    ...
    dataApproach:'Published registry/programme; survey details limited in public literature', funding:'National budget', metrics:'Approximate figures; literature-review completion entry (195-country coverage)' },
  { id:164, agency:'Latvian State Roads (LVC)', country:'Latvia', flag:'ð±ð»', networkKm:20093, system:'LVC road register', pavedPct:70, rmsYears:22, budgetPerKmUsd:20000, region:'Europe', lat:56.9, lng:24.6,
    ...
    dataApproach:'Published registry/programme; survey details limited in public literature', funding:'National budget', metrics:'Approximate figures; literature-review completion entry (195-country coverage)' },
  { id:165, agency:'Estonian Transport Administration', country:'Estonia', flag:'ðªðª', networkKm:16608, system:'Teeregister road registry', pavedPct:67, rmsYears:24, budgetPerKmUsd:25000, region:'Europe', lat:58.6, lng:25.0,
    ...
    dataApproach:'Published registry/programme; survey details limited in public literature', funding:'National budget', metrics:'Approximate figures; literature-review completion entry (195-country coverage)' },
  { id:166, agency:'Public Works Department', country:'Cyprus', flag:'ð¨ð¾', networkKm:13006, system:'PWD road inventory', pavedPct:65, rmsYears:15, budgetPerKmUsd:18000, region:'Europe', lat:35.1, lng:33.4,
    ...
    dataApproach:'Published registry/programme; survey details limited in public literature', funding:'National budget', metrics:'Approximate figures; literature-review completion entry (195-country coverage)' },
  { id:167, agency:'Infrastructure Malta', country:'Malta', flag:'ð²ð¹', networkKm:2855, system:'IM works programme', pavedPct:88, rmsYears:15, budgetPerKmUsd:30000, region:'Europe', lat:35.9, lng:14.4,
    ...
    dataApproach:'Published registry/programme; survey details limited in public literature', funding:'National budget', metrics:'Approximate figures; literature-review completion entry (195-country coverage)' },
  { id:168, agency:'Belavtodor', country:'Belarus', flag:'ð§ð¾', networkKm:86600, system:'Magistral road databank', pavedPct:86, rmsYears:18, budgetPerKmUsd:8000, region:'Europe', lat:53.7, lng:27.9,
    ...
    dataApproach:'Published registry/programme; survey details limited in public literature', funding:'National budget', metrics:'Approximate figures; literature-review completion entry (195-country coverage)' },
  { id:169, agency:'State Road Administration (ASD)', country:'Moldova', flag:'ð²ð©', networkKm:9352, system:'World Bank-supported RAMS', pavedPct:86, rmsYears:15, budgetPerKmUsd:7000, region:'Europe', lat:47.4, lng:28.4,
    ...
    dataApproach:'Published registry/programme; survey details limited in public literature', funding:'National budget', metrics:'Approximate figures; literature-review completion entry (195-country coverage)' },
  { id:170, agency:'Albanian Road Authority (ARRSH)', country:'Albania', flag:'ð¦ð±', networkKm:3945, system:'ARA road inventory', pavedPct:60, rmsYears:15, budgetPerKmUsd:9000, region:'Europe', lat:41.2, lng:20.2,
    ...
    dataApproach:'Published registry/programme; survey details limited in public literature', funding:'National budget', metrics:'Approximate figures; literature-review completion entry (195-country coverage)' },
  { id:171, agency:'Public Enterprise for State Roads', country:'North Macedonia', flag:'ð²ð°', networkKm:14182, system:'PESR road database', pavedPct:65, rmsYears:15, budgetPerKmUsd:9000, region:'Europe', lat:41.6, lng:21.7,
    ...
    dataApproach:'Published registry/programme; survey details limited in public literature', funding:'National budget', metrics:'Approximate figures; literature-review completion entry (195-country coverage)' },
  { id:172, agency:'JP Ceste FBiH / Putevi RS', country:'Bosnia and Herzegovina', flag:'ð§ð¦', networkKm:22926, system:'Entity road databases', pavedPct:52, rmsYears:12, budgetPerKmUsd:8000, region:'Europe', lat:43.9, lng:17.7,
    ...
    dataApproach:'Published registry/programme; survey details limited in public literature', funding:'National budget', metrics:'Approximate figures; literature-review completion entry (195-country coverage)' },
  { id:173, agency:'Uprava za saobracaj', country:'Montenegro', flag:'ð²ðª', networkKm:9505, system:'State road register', pavedPct:69, rmsYears:12, budgetPerKmUsd:10000, region:'Europe', lat:42.7, lng:19.4,
    ...
    dataApproach:'Published registry/programme; survey details limited in public literature', funding:'National budget', metrics:'Approximate figures; literature-review completion entry (195-country coverage)' },
  { id:174, agency:'AGEROUTE Cote d\'Ivoire', country:'Cote d\'Ivoire', flag:'ð¨ð®', networkKm:81996, system:'AGEROUTE road database', pavedPct:8, rmsYears:15, budgetPerKmUsd:5000, region:'Africa', lat:7.5, lng:-5.5,
    ...
    dataApproach:'Published registry/programme; survey details limited in public literature', funding:'National budget', metrics:'Approximate figures; literature-review completion entry (195-country coverage)' },
  { id:175, agency:'Ministere de l\'Equipement', country:'Congo', flag:'ð¨ð¬', networkKm:23324, system:'Basic inventory', pavedPct:7, rmsYears:5, budgetPerKmUsd:2500, region:'Africa', lat:-0.2, lng:15.8,
  ...
  { id:176, agency:'Ministerio de Transporte', country:'Cuba', flag:'ð¨ðº', networkKm:60858, system:'Centralised inventory', pavedPct:49, rmsYears:10, budgetPerKmUsd:3000, region:'Americas', lat:21.5, lng:-77.8,
    keyFeatures:['Limited published road asset-management literature','Network managed by the public works ministry'],
  ...
  { id:177, agency:'MTI', country:'Nicaragua', flag:'ð³ð®', networkKm:24137, system:'MTI pavement inventory (IDB-supported)', pavedPct:15, rmsYears:12, budgetPerKmUsd:4000, region:'Americas', lat:12.9, lng:-85.2,
    ...
    dataApproach:'Published registry/programme; survey details limited in public literature', funding:'National budget', metrics:'Approximate figures; literature-review completion entry (195-country coverage)' },
  { id:178, agency:'Ministry of Public Works', country:'Guyana', flag:'ð¬ð¾', networkKm:3995, system:'Project-based inventory', pavedPct:25, rmsYears:8, budgetPerKmUsd:5000, region:'Americas', lat:4.9, lng:-58.9,
    keyFeatures:['Limited published road asset-management literature','Network managed by the public works ministry'],
    lessonsDNR:'Literature review found no substantive published RMS/AMS for Guyana - entry records network basics only.',
    dataApproach:'No published systematic condition-survey programme identified', funding:'National budget', metrics:'Approximate figures; literature-review completion entry (195-country coverage)' },
  { id:179, agency:'Ministerie OWT&C', country:'Suriname', flag:'ð¸ð·', networkKm:4304, system:'Project-based inventory', pavedPct:27, rmsYears:8, budgetPerKmUsd:4000, region:'Americas', lat:3.9, lng:-56.0,
    keyFeatures:['Limited published road asset-management literature','Network managed by the public works ministry'],
    lessonsDNR:'Literature review found no substantive published RMS/AMS for Suriname - entry records network basics only.',
    dataApproach:'No published systematic condition-survey programme identified', funding:'National budget', metrics:'Approximate figures; literature-review completion entry (195-country coverage)' },
  { id:180, agency:'Ministry of Infrastructure (MIDH)', country:'Belize', flag:'ð§ð¿', networkKm:3281, system:'CDB-supported road programme', pavedPct:20, rmsYears:8, budgetPerKmUsd:5000, region:'Americas', lat:17.2, lng:-88.5,
    keyFeatures:['Limited published road asset-management literature','Network managed by the public works ministry'],
    lessonsDNR:'Literature review found no substantive published RMS/AMS for Belize - entry records network basics only.',
    dataApproach:'No published systematic condition-survey programme identified', funding:'National budget', metrics:'Approximate figures; literature-review completion entry (195-country coverage)' },
  { id:181, agency:'Ministry of Works', country:'Bahamas', flag:'ð§ð¸', networkKm:2700, system:'Islands works programme', pavedPct:57, rmsYears:8, budgetPerKmUsd:8000, region:'Americas', lat:25.0, lng:-77.4,
    keyFeatures:['Limited published road asset-management literature','Network managed by the public works ministry'],
    lessonsDNR:'Literature review found no substantive published RMS/AMS for Bahamas - entry records network basics only.',
    dataApproach:'No published systematic condition-survey programme identified', funding:'National budget', metrics:'Approximate figures; literature-review completion entry (195-country coverage)' },
  { id:182, agency:'Ministry of Transport & Works', country:'Barbados', flag:'ð§ð§', networkKm:1700, system:'MTW road inventory', pavedPct:80, rmsYears:10, budgetPerKmUsd:9000, region:'Americas', lat:13.2, lng:-59.5,
    keyFeatures:['Limited published road asset-management literature','Network managed by the public works ministry'],
    lessonsDNR:'Literature review found no substantive published RMS/AMS for Barbados - entry records network basics only.',
    dataApproach:'No published systematic condition-survey programme identified', funding:'National budget', metrics:'Approximate figures; literature-review completion entry (195-country coverage)' },
  { id:183, agency:'Ministry of Works & Transport', country:'Trinidad and Tobago', flag:'ð¹ð¹', networkKm:9592, system:'MOWT programme', pavedPct:51, rmsYears:12, budgetPerKmUsd:8000, region:'Americas', lat:10.7, lng:-61.2,
    ...
    dataApproach:'Published registry/programme; survey details limited in public literature', funding:'National budget', metrics:'Approximate figures; literature-review completion entry (195-country coverage)' },
  { id:184, agency:'Ministry of Public Works', country:'Timor-Leste', flag:'ð¹ð±', networkKm:6040, system:'ADB-supported road programme', pavedPct:42, rmsYears:8, budgetPerKmUsd:6000, region:'Asia-Pacific', lat:-8.9, lng:125.7,
    ...
    dataApproach:'Published registry/programme; survey details limited in public literature', funding:'National budget', metrics:'Approximate figures; literature-review completion entry (195-country coverage)' },
  { id:185, agency:'JKR Brunei (PWD)', country:'Brunei', flag:'ð§ð³', networkKm:3029, system:'JKR works system', pavedPct:81, rmsYears:15, budgetPerKmUsd:25000, region:'Asia-Pacific', lat:4.5, lng:114.7,
    ...
    dataApproach:'Published registry/programme; survey details limited in public literature', funding:'National budget', metrics:'Approximate figures; literature-review completion entry (195-country coverage)' },
  { id:186, agency:'Ministry of Public Works & Housing', country:'Palestine', flag:'ðµð¸', networkKm:4686, system:'Donor-supported inventory', pavedPct:90, rmsYears:8, budgetPerKmUsd:5000, region:'Middle East', lat:31.9, lng:35.2,
    keyFeatures:['Limited published road asset-management literature','Network managed by the public works ministry'],
    lessonsDNR:'Literature review found no substantive published RMS/AMS for Palestine - entry records network basics only.',
    dataApproach:'No published systematic condition-survey programme identified', funding:'National budget', metrics:'Approximate figures; literature-review completion entry (195-country coverage)' },
  { id:187, agency:'Ministry of Land & Maritime Transport', country:'North Korea', flag:'ð°ðµ', networkKm:25554, system:'No published system', pavedPct:3, rmsYears:0, budgetPerKmUsd:0, region:'Asia-Pacific', lat:40.3, lng:127.5,
    keyFeatures:['Limited published road asset-management literature','Network managed by the public works ministry'],
    lessonsDNR:'Literature review found no substantive published RMS/AMS for North Korea - entry records network basics only.',
    dataApproach:'No published systematic condition-survey programme identified', funding:'National budget + donor project support', metrics:'Approximate figures; literature-review completion entry (195-country coverage)' },
  { id:188, agency:'Govern d\'Andorra (COEX)', country:'Andorra', flag:'ð¦ð©', networkKm:320, system:'Mountain-road works unit', pavedPct:100, rmsYears:0, budgetPerKmUsd:0, region:'Europe', lat:42.5, lng:1.5,
    keyFeatures:['Limited published road asset-management literature','Network managed by the public works ministry'],
    lessonsDNR:'Literature review found no substantive published RMS/AMS for Andorra - entry records network basics only.',
    dataApproach:'No published systematic condition-survey programme identified', funding:'National budget', metrics:'Approximate figures; literature-review completion entry (195-country coverage)' },
  { id:189, agency:'Direction de l\'Amenagement Urbain', country:'Monaco', flag:'ð²ð¨', networkKm:77, system:'Urban works register', pavedPct:100, rmsYears:0, budgetPerKmUsd:0, region:'Europe', lat:43.7, lng:7.4,
    keyFeatures:['Limited published road asset-management literature','Network managed by the public works ministry'],
    lessonsDNR:'Literature review found no substantive published RMS/AMS for Monaco - entry records network basics only.',
    dataApproach:'No published systematic condition-survey programme identified', funding:'National budget', metrics:'Approximate figures; literature-review completion entry (195-country coverage)' },
  { id:190, agency:'AASLP', country:'San Marino', flag:'ð¸ð²', networkKm:292, system:'Public works authority', pavedPct:100, rmsYears:0, budgetPerKmUsd:0, region:'Europe', lat:43.9, lng:12.5,
    keyFeatures:['Limited published road asset-management literature','Network managed by the public works ministry'],
    lessonsDNR:'Literature review found no substantive published RMS/AMS for San Marino - entry records network basics only.',
    dataApproach:'No published systematic condition-survey programme identified', funding:'National budget', metrics:'Approximate figures; literature-review completion entry (195-country coverage)' },
  { id:191, agency:'Amt fur Bau und Infrastruktur', country:'Liechtenstein', flag:'ð±ð®', networkKm:630, system:'Cantonal-style register', pavedPct:100, rmsYears:0, budgetPerKmUsd:0, region:'Europe', lat:47.2, lng:9.5,
    keyFeatures:['Limited published road asset-management literature','Network managed by the public works ministry'],
    lessonsDNR:'Literature review found no substantive published RMS/AMS for Liechtenstein - entry records network basics only.',
    dataApproach:'No published systematic condition-survey programme identified', funding:'National budget', metrics:'Approximate figures; literature-review completion entry (195-country coverage)' },
  { id:192, agency:'Governatorato', country:'Vatican City', flag:'ð»ð¦', networkKm:3, system:'City-state maintenance', pavedPct:100, rmsYears:0, budgetPerKmUsd:0, region:'Europe', lat:41.9, lng:12.45,
    keyFeatures:['Limited published road asset-management literature','Network managed by the public works ministry'],
    lessonsDNR:'Literature review found no substantive published RMS/AMS for Vatican City - entry records network basics only.',
    dataApproach:'No published systematic condition-survey programme identified', funding:'National budget', metrics:'Approximate figures; literature-review completion entry (195-country coverage)' },
  { id:193, agency:'Ministry of Works', country:'Antigua and Barbuda', flag:'ð¦ð¬', networkKm:1170, system:'Islands works programme', pavedPct:33, rmsYears:0, budgetPerKmUsd:0, region:'Americas', lat:17.1, lng:-61.8,
    keyFeatures:['Limited published road asset-management literature','Network managed by the public works ministry'],
    ...
    dataApproach:'No published systematic condition-survey programme identified', funding:'National budget', metrics:'Approximate figures; literature-review completion entry (195-country coverage)' },
  { id:194, agency:'Ministry of Public Works', country:'Dominica', flag:'ð©ð²', networkKm:1512, system:'Climate-resilience rebuild (post-Maria)', pavedPct:50, rmsYears:0, budgetPerKmUsd:0, region:'Americas', lat:15.4, lng:-61.3,
    keyFeatures:['Limited published road asset-management literature','Network managed by the public works ministry'],
    lessonsDNR:'Literature review found no substantive published RMS/AMS for Dominica - entry records network basics only.',
    dataApproach:'No published systematic condition-survey programme identified', funding:'National budget', metrics:'Approximate figures; literature-review completion entry (195-country coverage)' },
  { id:195, agency:'Ministry of Infrastructure', country:'Grenada', flag:'ð¬ð©', networkKm:1127, system:'Islands works programme', pavedPct:61, rmsYears:0, budgetPerKmUsd:0, region:'Americas', lat:12.1, lng:-61.7,
    keyFeatures:['Limited published road asset-management literature','Network managed by the public works ministry'],
    lessonsDNR:'Literature review found no substantive published RMS/AMS for Grenada - entry records network basics only.',
    dataApproach:'No published systematic condition-survey programme identified', funding:'National budget', metrics:'Approximate figures; literature-review completion entry (195-country coverage)' },
  { id:196, agency:'Public Works Department', country:'Saint Kitts and Nevis', flag:'ð°ð³', networkKm:383, system:'Islands works programme', pavedPct:42, rmsYears:0, budgetPerKmUsd:0, region:'Americas', lat:17.3, lng:-62.7,
    keyFeatures:['Limited published road asset-management literature','Network managed by the public works ministry'],
    ...
    dataApproach:'No published systematic condition-survey programme identified', funding:'National budget', metrics:'Approximate figures; literature-review completion entry (195-country coverage)' },
  { id:197, agency:'Ministry of Infrastructure', country:'Saint Lucia', flag:'ð±ð¨', networkKm:1210, system:'Islands works programme', pavedPct:65, rmsYears:0, budgetPerKmUsd:0, region:'Americas', lat:13.9, lng:-61.0,
    keyFeatures:['Limited published road asset-management literature','Network managed by the public works ministry'],
    lessonsDNR:'Literature review found no substantive published RMS/AMS for Saint Lucia - entry records network basics only.',
    dataApproach:'No published systematic condition-survey programme identified', funding:'National budget', metrics:'Approximate figures; literature-review completion entry (195-country coverage)' },
  { id:198, agency:'BRAGSA', country:'Saint Vincent and the Grenadines', flag:'ð»ð¨', networkKm:829, system:'Roads & buildings authority', pavedPct:70, rmsYears:0, budgetPerKmUsd:0, region:'Americas', lat:13.2, lng:-61.2,
    keyFeatures:['Limited published road asset-management literature','Network managed by the public works ministry'],
    ...
    dataApproach:'No published systematic condition-survey programme identified', funding:'National budget', metrics:'Approximate figures; literature-review completion entry (195-country coverage)' },
  { id:199, agency:'Ministry of Infrastructure', country:'Kiribati', flag:'ð°ð®', networkKm:670, system:'World Bank KRRP road project', pavedPct:5, rmsYears:0, budgetPerKmUsd:0, region:'Asia-Pacific', lat:1.9, lng:-157.4,
    keyFeatures:['Limited published road asset-management literature','Network managed by the public works ministry'],
    lessonsDNR:'Literature review found no substantive published RMS/AMS for Kiribati - entry records network basics only.',
    dataApproach:'No published systematic condition-survey programme identified', funding:'National budget + donor project support', metrics:'Approximate figures; literature-review completion entry (195-country coverage)' },
  { id:200, agency:'Ministry of Works', country:'Marshall Islands', flag:'ð²ð­', networkKm:1448, system:'Atoll works programme', pavedPct:5, rmsYears:0, budgetPerKmUsd:0, region:'Asia-Pacific', lat:7.1, lng:171.2,
    keyFeatures:['Limited published road asset-management literature','Network managed by the public works ministry'],
    ...
    dataApproach:'No published systematic condition-survey programme identified', funding:'National budget + donor project support', metrics:'Approximate figures; literature-review completion entry (195-country coverage)' },
  { id:201, agency:'Dept. of Transportation & Infrastructure', country:'Micronesia', flag:'ð«ð²', networkKm:388, system:'Compact-funded works', pavedPct:18, rmsYears:0, budgetPerKmUsd:0, region:'Asia-Pacific', lat:6.9, lng:158.2,
    keyFeatures:['Limited published road asset-management literature','Network managed by the public works ministry'],
    lessonsDNR:'Literature review found no substantive published RMS/AMS for Micronesia - entry records network basics only.',
    dataApproach:'No published systematic condition-survey programme identified', funding:'National budget + donor project support', metrics:'Approximate figures; literature-review completion entry (195-country coverage)' },
  { id:202, agency:'Nauru Utilities / Works', country:'Nauru', flag:'ð³ð·', networkKm:30, system:'Ring-road maintenance', pavedPct:80, rmsYears:0, budgetPerKmUsd:0, region:'Asia-Pacific', lat:-0.5, lng:166.9,
    keyFeatures:['Limited published road asset-management literature','Network managed by the public works ministry'],
    lessonsDNR:'Literature review found no substantive published RMS/AMS for Nauru - entry records network basics only.',
    dataApproach:'No published systematic condition-survey programme identified', funding:'National budget + donor project support', metrics:'Approximate figures; literature-review completion entry (195-country coverage)' },
  { id:203, agency:'Bureau of Public Works', country:'Palau', flag:'ðµð¼', networkKm:125, system:'Compact-road maintenance', pavedPct:48, rmsYears:0, budgetPerKmUsd:0, region:'Asia-Pacific', lat:7.5, lng:134.6,
    keyFeatures:['Limited published road asset-management literature','Network managed by the public works ministry'],
    lessonsDNR:'Literature review found no substantive published RMS/AMS for Palau - entry records network basics only.',
    dataApproach:'No published systematic condition-survey programme identified', funding:'National budget + donor project support', metrics:'Approximate figures; literature-review completion entry (195-country coverage)' },
  { id:204, agency:'Land Transport Authority (LTA)', country:'Samoa', flag:'ð¼ð¸', networkKm:2337, system:'LTA road register (World Bank-supported)', pavedPct:42, rmsYears:10, budgetPerKmUsd:4000, region:'Asia-Pacific', lat:-13.8, lng:-172.1,
    ...
    dataApproach:'Published registry/programme; survey details limited in public literature', funding:'National budget', metrics:'Approximate figures; literature-review completion entry (195-country coverage)' },
  { id:205, agency:'Ministry of Infrastructure Development', country:'Solomon Islands', flag:'ð¸ð§', networkKm:1390, system:'ADB-supported road programme', pavedPct:3, rmsYears:0, budgetPerKmUsd:0, region:'Asia-Pacific', lat:-9.6, lng:160.2,
    keyFeatures:['Limited published road asset-management literature','Network managed by the public works ministry'],
    ...
    dataApproach:'No published systematic condition-survey programme identified', funding:'National budget + donor project support', metrics:'Approximate figures; literature-review completion entry (195-country coverage)' },
  { id:206, agency:'Ministry of Infrastructure', country:'Tonga', flag:'ð¹ð´', networkKm:680, system:'Islands works programme', pavedPct:29, rmsYears:0, budgetPerKmUsd:0, region:'Asia-Pacific', lat:-21.2, lng:-175.2,
    keyFeatures:['Limited published road asset-management literature','Network managed by the public works ministry'],
    lessonsDNR:'Literature review found no substantive published RMS/AMS for Tonga - entry records network basics only.',
    dataApproach:'No published systematic condition-survey programme identified', funding:'National budget + donor project support', metrics:'Approximate figures; literature-review completion entry (195-country coverage)' },
  { id:207, agency:'Public Works Department', country:'Tuvalu', flag:'ð¹ð»', networkKm:8, system:'Single-island maintenance', pavedPct:100, rmsYears:0, budgetPerKmUsd:0, region:'Asia-Pacific', lat:-8.5, lng:179.1,
    keyFeatures:['Limited published road asset-management literature','Network managed by the public works ministry'],
    lessonsDNR:'Literature review found no substantive published RMS/AMS for Tuvalu - entry records network basics only.',
    dataApproach:'No published systematic condition-survey programme identified', funding:'National budget + donor project support', metrics:'Approximate figures; literature-review completion entry (195-country coverage)' },
  { id:208, agency:'Public Works Department', country:'Vanuatu', flag:'ð»ðº', networkKm:1070, system:'VTSSP road programme', pavedPct:10, rmsYears:0, budgetPerKmUsd:0, region:'Asia-Pacific', lat:-15.4, lng:166.9,
    keyFeatures:['Limited published road asset-management literature','Network managed by the public works ministry'],
    lessonsDNR:'Literature review found no substantive published RMS/AMS for Vanuatu - entry records network basics only.',
    dataApproach:'No published systematic condition-survey programme identified', funding:'National budget + donor project support', metrics:'Approximate figures; literature-review completion entry (195-country coverage)' },
  { id:209, agency:'INAE', country:'Sao Tome and Principe', flag:'ð¸ð¹', networkKm:320, system:'Basic inventory', pavedPct:68, rmsYears:0, budgetPerKmUsd:0, region:'Africa', lat:0.2, lng:6.6,
    keyFeatures:['Limited published road asset-management literature','Network managed by the public works ministry'],
...
// ââ Lessons data ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
...
const LESSONS: LessonTheme[] = [
  ...
  },
  {
    ...
    lessons: [
      ...
      { point: 'GIS integration is non-negotiable', source: 'Multiple (GHA, ERA, RTDA)', detail: 'All successful systems link condition data directly to geospatial road network â enabling map-based programming.' },
  ...
  },
  {
    ...
    lessons: [
      ...
      { point: 'LCC over 40-year horizon eliminates cheapest-upfront bias', source: 'Austroads / Trafikverket', detail: 'Whole-of-life cost analysis consistently shows preventive treatment is 3-6Ã cheaper than rehabilitation.' },
      { point: '10-15 year rolling programme reduces emergency reactive spending', source: 'Highways England (UK)', detail: 'Long-horizon planning allows budget smoothing and contractor capacity planning â reduces reactive spend.' },
    ],
  },
  {
...
// ââ Shared style atoms ââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
...
// ââ Tab 1: World Map ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
...
function WorldMapTab() {
  ...
  // definite-height parent â percentage chains and min-heights collapse to 0.
  return (
...
// ââ Tab 2: Case Studies âââââââââââââââââââââââââââââââââââââââââââââââââââââââ
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8, marginBottom: 12, alignItems: 'center' }}>
        ...
        <div style={{
          ...
          <input
            ...
            placeholder="Search agency or countryâ¦"
            style={{
...
// ââ Tab 3: Comparative Analytics âââââââââââââââââââââââââââââââââââââââââââââ
      ...
      <div style={S.card()}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
          <div style={{ fontSize: 12, fontWeight: 700, color: '#e2e8f0' }}>
            Full Comparison Table â All {CASE_STUDIES.length} Agencies
          </div>
          <button
...
// ââ Tab 4: Lessons & Recommendations âââââââââââââââââââââââââââââââââââââââââ
  ...
  return (
    <div style={S.sectionPad}>
          ...
          return (
            ...
            >
              ...
              >
                ...
                <span style={{ fontSize: 12, color: theme.color, opacity: 0.7 }}>{open ? 'â²' : 'â¼'}</span>
              </button>
      ...
      <div style={{
        ...
        <strong style={{ color: '#ffd23f' }}>{LESSONS.length} themes</strong> â all directly applicable to DNR's Road Management System.
      </div>
    </div>
  );
}

// ââ Literature Review Matrix ââââââââââââââââââââââââââââââââââââââââââââââââââ
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
          <div style={{ fontWeight: 800, fontSize: 13, color: '#00f5ff' }}>
            AM Component Radar â {countries.map(c => c.flag + ' ' + c.country).join(' vs ')}
          </div>
          <button onClick={onClose} style={{ background: 'none', border: 'none', color: '#94a3b8', cursor: 'pointer', fontSize: 16 }}>â</button>
        </div>
    ...
    <div style={{ ...S.sectionPad, position: 'absolute', inset: 0, overflow: 'hidden', display: 'flex', flexDirection: 'column', gap: 10 }}>
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8, alignItems: 'center', flexShrink: 0 }}>
        ...
        <span style={{ fontSize: 9, color: 'rgba(148,163,184,0.45)', marginLeft: 'auto' }}>
          {rows.length} countries Â· click row for radar Â· {compareMode ? 'select 2 to compare' : 'toggle Compare for side-by-side'}
        </span>
      </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <div>
            <div style={{ fontWeight: 800, fontSize: 15, color: '#00f5ff', letterSpacing: '-0.01em' }}>
              Global Road Management â Case Studies
            </div>
            <div style={{ fontSize: 10, color: 'rgba(148,163,184,0.6)', marginTop: 1 }}>
              {CASE_STUDIES.length} agencies Â· {Object.keys(REGION_COLOR).length} regions Â· International best practice for DNR
            </div>
          </div>
        </div>
      </div>
