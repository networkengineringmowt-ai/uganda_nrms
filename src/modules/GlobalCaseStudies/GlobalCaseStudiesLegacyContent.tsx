...
const CASE_STUDIES: CaseStudy[] = [
  ...
  { id:37, agency:'MoWT / DNR', country:'Uganda', flag:'', networkKm:21302, system:'DNR RMS Engine', pavedPct:30, rmsYears:6, budgetPerKmUsd:12500, region:'Africa', lat:1.37, lng:32.29,
...
export default function GlobalCaseStudiesLegacyContent({ initialTab, hideTabBar }: { initialTab?: TabId | 'dashboard'; hideTabBar?: boolean } = {}) {
  const [tab, setTab] = useState<TabId>((initialTab || 'analytics') as TabId);
