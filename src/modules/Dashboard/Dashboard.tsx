  ...
  return (
    <div style={{
      ...
      fontFamily:`'Inter','Segoe UI',sans-serif`,
        ...
        <div style={{background:'rgba(77,153,255,0.04)',border:'1px solid rgba(77,153,255,0.14)',borderRadius:10,padding:'10px 16px',marginBottom:16,display:'flex',alignItems:'center',gap:10,flexWrap:'wrap'}}>
          <span style={{fontSize:15,fontWeight:800,color:'rgba(77,153,255,1)',letterSpacing:-0.3}}>Section Roads Dashboard</span>
          <span style={{fontSize:11,color:'#94a3b8',fontWeight:500}}>MoWT · Condition · Traffic · Budget · HDM-4</span>
        </div>
