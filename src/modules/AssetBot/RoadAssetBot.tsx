  ...
  return (
    <>
      ...
      {open && (
        ...
        <div style={{background:'rgba(124,58,237,0.04)',border:'1px solid rgba(124,58,237,0.14)',borderRadius:10,padding:'10px 16px',marginBottom:16,display:'flex',alignItems:'center',gap:10,flexWrap:'wrap'}}>
          <span style={{fontSize:15,fontWeight:800,color:'rgba(124,58,237,1)',letterSpacing:-0.3}}>Road Asset Intelligence Bot</span>
