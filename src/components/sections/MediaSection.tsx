...
const STORIES: StorySection[] = [
  ...
  },
  {
    ...
    subtitle: '998 registered structures under Bridge Management System monitoring — inspected to NBI standards',
    images: [
    ...
    <section style={{ padding: '12px 16px', minHeight: 0,
      ...
      <div style={{ marginBottom: 44 }}>
        <SectionDivider
          ...
          subtitle="Structural photography from the 998-structure bridge registry"
          color="#00d4aa"
        />
